...
const FoodAndBeverageOilsPage = () => {
  ...
  useEffect(() => {
    ...
    // Dynamic SEO update
    document.title = "Food & Beverage Aroma Oils | Cool Max Scent";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Explore Food & Beverage aroma oils by Cool Max Scent, featuring warm and inviting fragrances like True Coffee, ideal for cafes, restaurants, bakeries & etc.");
    }
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/food-and-beverage-aroma-oil/');
  }, []);
  ...
  const oils = [
    {
      ...
      strength: "Medium",
      path: "/food-and-beverage-aroma-oil/true-coffee/",
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-24 pb-12 px-6 lg:px-12 max-w-[1600px] mx-auto text-center">
          <motion.div {...fadeUp}>
            ...
            <div className="flex flex-wrap justify-center gap-5 font-sans">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="px-10 py-4 bg-blue-600 text-white rounded-full font-bold text-[11px] uppercase tracking-widest hover:bg-slate-900 transition-all flex items-center justify-center gap-2 shadow-xl shadow-blue-100">
            ...
            <div className="flex justify-center">
              {oils.map((oil, idx) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif text-slate-900 mb-2 group-hover:text-blue-700 transition-colors tracking-tight italic">
                    {oil.name}
                  </h3>
        ...
        <section className="py-24 bg-slate-950 text-white px-6">
          <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center">
              Best Used For
            </h2>
        ...
        <section className="py-24 px-6">
          <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase italic text-slate-200 text-center">
