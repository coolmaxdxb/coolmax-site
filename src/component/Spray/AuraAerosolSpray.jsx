    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
            <Helmet>
                ...
                <link rel="canonical" href="https://coolmaxscent.com/aura-aerosol-spray" />
            </Helmet>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans text-left text-justify">
                            Aura Aerosol Spray by Cool Max Scent is designed to create a refined and refreshing indoor atmosphere using a harmonious blend of citrus, soft florals, and warm musky notes. This fragrance delivers a clean and calming experience that feels professional, subtle, and long-lasting.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans text-left">
                            Ideal for continuous use, Aura helps maintain freshness while supporting comfort and hygiene perception in both personal and commercial environments.
                        </p>
                ...
                <div className="max-w-[1200px] mx-auto font-sans text-left">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans text-left">
                        {[
                            ...
                            { label: "Base", notes: "White Musk, Sandalwood", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center text-left">
                        "The fragrance opens with bright citrus notes, moves into calming lavender, and finishes with smooth white musk and woody undertones for a clean, elegant profile."
                    </p>
                </div>
            </section>
                    ...
                    <div className="text-left">
                        ...
                        <ul className="space-y-6 text-left">
                            {[
                                ...
                                "Clean citrus–musky fragrance profile",
            ...
            <section className="py-24 bg-slate-950 text-white px-6 font-sans text-left">
                <div className="max-w-[1200px] mx-auto text-center text-left">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto text-center text-left">Aura Aerosol Spray is crafted for reliable performance in professional scenting systems, helping businesses maintain a calm, fresh, and welcoming atmosphere.</p>
...
export default AuraAerosolSprayDetail;