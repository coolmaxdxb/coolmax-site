...
const navigation = [
  { name: "Home", href: "/", type: "link" },
  {
    ...
    cols: 2,
    items: [
       { label: "Commercial Diffusers", href: "/commercial-aroma-diffuser/" },
        { label: "Large Area & HVAC", href: "/large-area-and-hvac-aroma-diffusers/ " },
      { label: "Car Aroma Diffusers", href: "/car-aroma-diffusers/" },
      { label: "Desktop & Small Space", href: "/desktop-and-small-space-aroma-diffuser/" },
      ...
      { label: "AerosolDispensers", href: "/aerosoldispensers/" },
    ],
  },
  {
    name: "Aroma Oils",
