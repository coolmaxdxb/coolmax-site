...
const FantasticAerosolSprayDetail = () => {
    ...
    useEffect(() => {
        ...
        if (metaDesc) {
            metaDesc.setAttribute("content", "Fantastic Aerosol Spray by Cool Max Scent blends lemon zest, orange peel, green apple, jasmine, and light lavender for bright, refreshing freshness.");
        }
        ...
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8 font-sans">
                            <SparklesIcon className="w-4 h-4" /> Category: Citrus Fresh Aerosol Air Freshener
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Fantastic <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider font-sans">
                            Citrus Fresh Air Freshener – Vibrant Citrus Brightness with a Clean, Modern Feel
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
                            Fantastic Aerosol Spray by Cool Max Scent is designed to energize indoor spaces with a lively citrus opening and a crisp fruity heart. Balanced with soft florals and light herbal tones, this fragrance delivers an instant sense of cleanliness while remaining smooth and non-overpowering.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans">
                            Ideal for professional environments and everyday use, Fantastic keeps spaces feeling fresh, active, and welcoming throughout the day.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto font-sans">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-16 font-sans text-center">
                        {[
                            { label: "Top Notes", notes: "Lemon Zest, Orange Peel", color: "bg-blue-400" },
                            { label: "Heart Notes", notes: "Green Apple, Jasmine", color: "bg-blue-600" },
                            { label: "Base Notes", notes: "Light Lavender", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
                        "The scent opens with sparkling citrus, moves into fresh green apple, and settles into gentle floral and herbal notes for a clean finish."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Instant freshness with effective odor control",
                                "Wide fragrance dispersion for even coverage",
                                "Bright, uplifting scent profile",
                                "Leaves no residue",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500 font-sans">
                            ...
                            <span className="text-[11px] font-bold uppercase text-blue-50">High-Traffic Areas</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-950 text-white px-6 font-sans">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto text-center">Fantastic Aerosol Spray supports hygiene perception and comfort, making it suitable for high-traffic areas that need a consistently fresh atmosphere.</p>
                    <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
                        {["Washrooms & Restrooms", "Offices & Corporate", "Retail & Showrooms", "Hotels & Hospitality", "Corridors & Common Areas"].map((item, i) => (
                    ...
                    <div className="bg-slate-50 rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-center md:text-left">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-slate-500 font-light leading-relaxed font-sans">
                                Cool Max Scent aerosol sprays are selected for reliable performance in professional dispenser systems. They help maintain clean, pleasant environments with controlled fragrance delivery and minimal effort.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-6 text-center">
                <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans">
                    ...
                    <p className="text-slate-400 text-lg md:text-2xl mb-12 relative z-10 max-w-3xl mx-auto leading-relaxed font-light font-sans text-center">
                        For automated freshness and consistent results, pair Fantastic Aerosol Spray with Cool Max Scent LED or LCD Aerosol Dispensers.
                    </p>
...
export default FantasticAerosolSprayDetail;