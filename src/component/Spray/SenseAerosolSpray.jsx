...
const SenseAerosolSprayDetail = () => {
    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
                ...
                <link rel="canonical" href="https://www.coolmaxscent.com/spray/sense-aerosol-spray"/>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-blue-50">Hotels & Hospitality</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-950 text-white px-6 text-left">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto">Sense Aerosol Spray is developed for consistent performance in professional scenting systems, making it a practical choice for businesses.</p>
