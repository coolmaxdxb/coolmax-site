...
const ArabianBakhourAromaOilDetail = () => {
  // Redirection Links
  ...
  <link rel="canonical" href="https://www.coolmaxscent.com/oriental-aroma-oil/arabian-bakhour/" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
              ARABIAN <span className="italic font-light text-slate-700">BAKHOUR</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
              Traditional Oriental Fragrance with Warm & Inviting Character
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                <span>Item Code: <span className="text-slate-900">CM-0103-OR</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
              Arabian Bakhour Aroma Oil is a classic oriental fragrance inspired by traditional bakhour scents. This fragrance blends soft florals with warm spices and a subtly sweet base to create a rich, inviting, and long-lasting atmosphere.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
              It is designed for spaces that want to evoke tradition, warmth, and cultural elegance.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
             {[
               { label: "Top Notes", notes: "Jasmine, Rose", color: "bg-blue-600" },
               { label: "Middle Notes", notes: "Saffron, Clove", color: "bg-blue-700" },
               { label: "Base Notes", notes: "Vanilla, Pineapple", color: "bg-blue-800" }
             ].map((note, i) => (
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
           <div className="text-left">
             ...
             <ul className="space-y-6">
                {[
                    "Soft floral opening with warmth",
                    "Traditional oriental spice character",
                    "Sweet, comforting, long-lasting finish"
                ].map((text, i) => (
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-sans font-light">
                Arabian Bakhour Aroma Oil creates a welcoming environment while maintaining a strong and memorable scent presence.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6">
              <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                <ShoppingBagIcon className="w-12 h-12 text-blue-500 group-hover:text-white" />
                <span className="text-[11px] font-bold uppercase text-slate-200">Showrooms</span>
              </div>
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Hotels</span>
              </div>
              <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Premium Lounges</span>
              </div>
              <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-blue-50">Cultural Interiors</span>
              </div>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-950 text-white px-6">
        <div className="max-w-[1200px] mx-auto text-left">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 text-center tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose Arabian Bakhour?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    { title: "Noticeable Diffusion", desc: "Strong intensity ensures a prominent and effective aroma throughout your space." },
            ...
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center">
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed">
                        Arabian Bakhour Aroma Oil is a professional fragrance oil designed for use with automated scent diffuser machines. Fragrance intensity can be adjusted based on space size and layout for a controlled and pleasant scent experience.
                    </p>
                </div>
            </div>
        </div>
...
export default ArabianBakhourAromaOilDetail;