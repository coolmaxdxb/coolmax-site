      ...
      <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              {oils.map((oil, idx) => (
                ...
                >
                  ...
                  <h3 className="text-3xl font-serif text-slate-900 mb-2 group-hover:text-blue-700 transition-colors tracking-tight italic text-left">{oil.name}</h3>
                  <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1 text-left">Category: {oil.category}</p>
                  <p className="text-[10px] font-bold text-blue-600 uppercase tracking-[0.2em] mb-6 font-sans text-left">Item Code: {oil.code}</p>
                  
                  <div className="space-y-6 mb-10 flex-grow font-sans text-left">
                  ...
                  <Link 
                    to={oil.path}
                    className="w-full py-5 bg-slate-900 text-white rounded-xl font-bold text-[11px] uppercase tracking-[0.2em] hover:bg-blue-600 transition-all flex items-center justify-center gap-3 shadow-md font-sans text-center"
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 font-sans">
              {[
                ...
                <Link 
                  key={i} 
                  to={cat.path}
                  className="p-6 bg-white border border-slate-200 rounded-2xl hover:border-blue-600 hover:shadow-xl transition-all group text-center"
                >
        ...
        <section className="py-24 px-6">
          <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase italic text-slate-200 text-center">The Ultimate Signature Scent</h2>
