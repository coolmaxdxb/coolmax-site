...
import P12 from "../../../asset/Aroma oils img/FOR YOU.webp"; 

const ForYouAromaOilDetail = () => {
  // Redirection Links
  const whatsappNumber = "+971509282702";
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20For%20You%20Aroma%20Oil%20(CM-0109-OR).`;
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/perfumers-choice-aroma-oil/for-you/');
  }, []);
  ...
  return (
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
              FOR YOU <span className="italic font-light text-slate-700">AROMA OIL</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider text-left">
              Soft & Elegant Perfumers Choice Fragrance for Everyday Comfort
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400 text-left">
                <span>Item Code: <span className="text-slate-900">CM-0109-OR</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans text-left">
              For You Aroma Oil is a refined and graceful fragrance designed for everyday elegance. With a vibrant fruity opening, a delicate floral heart, and a warm musky base, this fragrance creates a pleasant, comforting, and inviting atmosphere without being overpowering.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic text-left">
              It is ideal for spaces that value subtle sophistication and balanced freshness.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 font-sans text-center">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 text-center">
             {[
               { label: "Top Notes", notes: "Yuzu, Pomegranate, Apricot, Bergamot", color: "bg-blue-400" },
               { label: "Middle Notes", notes: "Jasmine, Peony, Magnolia, Peach, Lotus Flower", color: "bg-blue-600" },
               { label: "Base Notes", notes: "White Musk, Vanilla, Mahogany, Amber", color: "bg-blue-800" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center">
            "This fragrance opens with bright fruity-citrus freshness, develops into a smooth floral heart, and finishes with a warm, softly musky base that lingers comfortably."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div>
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-sans font-light text-left">
                For You Aroma Oil delivers a balanced scent experience that feels welcoming and versatile.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6 text-left">
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-600 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100">Corporate Spaces</span>
              </div>
      ...
      <section className="py-24 bg-slate-950 text-white px-6 font-sans text-left">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose For You Aroma?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                {[
                    { title: "Controlled Diffusion", desc: "Medium strength intensity designed for perfectly balanced area coverage." },
            ...
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left">
                ...
                <div className="text-left">
                    ...
                    <p className="text-slate-500 font-light leading-relaxed text-left">
                        For You Aroma Oil is a professional fragrance oil intended for use with automated scent diffuser machines. Diffusion intensity can be adjusted according to space size and airflow for optimal comfort.
                    </p>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans text-center">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-white text-center">Interested in <br/><span className="italic font-light text-slate-300 text-center">this fragrance?</span></h2>
...
export default ForYouAromaOilDetail;