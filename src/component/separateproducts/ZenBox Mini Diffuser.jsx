...
const ZenBoxMiniPage = () => {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/wall-mounted-and-ceiling-aroma-diffusers/zenbox-mini-diffuser/');
  }, []);
    ...
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden text-left">
        ...
        <div className="grid gap-16 text-left">
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            <div className="order-2 md:order-1 text-left">
              <h3 className="text-xl font-serif mb-4 text-slate-900 text-left">Novel Exterior Design</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            ...
            <div className="text-left">
              <h3 className="text-xl font-serif mb-4 text-slate-900 text-left">Four-Button Display Panel</h3>
              <p className="text-sm text-slate-500 mb-4 font-light text-left text-left">The built-in four-button control panel allows users to precisely manage their environment:</p>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            <div className="bg-slate-900 text-white p-8 rounded-[2rem] shadow-xl text-left text-left">
               <ArrowsPointingOutIcon className="w-10 h-10 text-blue-400 mb-4 text-left" />
               <h3 className="text-xl font-serif mb-2 text-left text-white">Dual Placement Flexibility</h3>
               <p className="text-slate-400 text-xs leading-relaxed mb-4 font-light text-left">Designed for dual placement to optimize fragrance based on space layout and airflow.</p>
               <div className="flex gap-4 text-left">
                  <div className="px-3 py-1 bg-white/5 rounded-lg border border-white/10 text-[9px] font-black uppercase tracking-widest text-blue-200 text-center">Wall-Mounted</div>
                  <div className="px-3 py-1 bg-white/5 rounded-lg border border-white/10 text-[9px] font-black uppercase tracking-widest text-blue-200 text-center">Desktop</div>
               </div>
            </div>
            <div className="bg-blue-600 text-white p-8 rounded-[2rem] shadow-xl text-left text-left text-white">
               <Battery100Icon className="w-10 h-10 text-white mb-4 text-left" />
               <h3 className="text-xl font-serif mb-2 text-left">Battery Convenience</h3>
               <p className="text-blue-100 text-xs leading-relaxed mb-4 font-light italic text-left">Powered by 3 AA batteries, ZenBox Mini Diffuser offers cable-free installation and easy replacement in any area.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
             <div className="p-8 bg-white border border-slate-100 rounded-3xl shadow-sm text-left">
                ...
                <h3 className="text-lg font-serif mb-2 text-left text-slate-900">Quiet Operation</h3>
                <p className="text-slate-500 font-light text-xs leading-relaxed text-left">Operating at ≤63 dB, delivers effective aroma diffusion while maintaining a stable and reliable operation.</p>
             </div>
             <div className="p-8 bg-white border border-slate-100 rounded-3xl shadow-sm text-left">
                <ShieldCheckIcon className="w-8 h-8 text-blue-600 mb-4 text-left" />
                <h3 className="text-lg font-serif mb-2 text-left text-slate-900">Durable Build</h3>
                <p className="text-slate-500 font-light text-xs leading-relaxed text-left">Made from high-quality PP material, the lightweight yet durable body is easy to clean and safe for operation.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-center text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center text-left text-left">
          <div className="relative h-80 text-left">
             <img src={ZenBoxMini4} alt="Placement Detail" className="w-full h-full object-contain rounded-[2rem] shadow-xl text-left" />
             <div className="absolute -bottom-4 -right-4 p-6 bg-blue-600 text-white rounded-2xl shadow-xl text-left">
                <span className="text-xl font-black italic uppercase text-left">No Wires</span>
                <p className="text-[8px] font-bold uppercase tracking-widest text-left">AA Battery Powered</p>
             </div>
          </div>
          <div className="text-left">
            <h2 className="text-2xl md:text-4xl font-serif mb-6 tracking-tight leading-tight text-slate-900 text-left">Why Choose ZenBox Mini Diffuser</h2>
            ...
            <p className="mt-6 text-slate-400 font-medium text-[11px] italic text-left text-justify text-left">A practical choice for users seeking a compact home diffuser with controlled output.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto text-center border-t border-slate-100 pt-16 text-left">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto text-center">
            {["OpalMist Clock", "LuxePanel Diffuser", "AeroCube Diffuser"].map((range, i) => (
              <div key={i} className="p-6 rounded-2xl bg-white border border-slate-100 hover:border-blue-600 transition-all font-bold uppercase tracking-widest text-[9px] text-slate-500 cursor-pointer text-center text-center">
                Explore {range}
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-6 text-left">
        <div className="max-w-[1200px] mx-auto bg-[#0c101b] rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl text-left">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mb-6 relative z-10 tracking-tight leading-tight text-center text-center">Bring Controlled Fragrance to Small Spaces</h2>
