...
import TajSunsetImg from "../../asset/Aroma oils img/TAJ SUNSET.webp"; 
import ClassicImg from "../../asset/Aroma oils img/CLASSIC.webp"; 
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              {oils.map((oil, idx) => (
                ...
                >
                  ...
                  <h3 className="text-3xl font-serif text-slate-900 mb-2 group-hover:text-blue-700 transition-colors tracking-tight italic">
                    {oil.name}
                  </h3>
                  <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">
                    Category: {oil.category}
                  </p>
                  <p className="text-[10px] font-bold text-blue-600 uppercase tracking-[0.2em] mb-6 font-sans">
                    Item Code: {oil.code}
                  </p>
                  
                  <div className="space-y-6 mb-10 flex-grow font-sans">
                    <h4 className="text-[11px] font-black uppercase text-slate-900 border-b border-slate-100 pb-2">
                      Fragrance Notes:
                    </h4>
                     <div className="pb-4 border-b border-slate-100">
                       <p className="text-[10px] font-bold uppercase text-slate-400 mb-2 tracking-widest">Top Notes</p>
                       <p className="text-[13px] text-slate-600 leading-snug font-medium">{oil.top}</p>
                     </div>
                     <div className="pb-4 border-b border-slate-100">
                       <p className="text-[10px] font-bold uppercase text-slate-400 mb-2 tracking-widest">Middle Notes</p>
                       <p className="text-[13px] text-slate-600 leading-snug font-medium">{oil.middle}</p>
                     </div>
                     <div>
                       <p className="text-[10px] font-bold uppercase text-slate-400 mb-2 tracking-widest">Base Notes</p>
                       <p className="text-[13px] text-slate-600 leading-snug font-medium">{oil.base}</p>
                     </div>
                  </div>
          ...
          <div className="max-w-[1000px] mx-auto text-center">
            <motion.div {...fadeUp}>
              ...
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-light mb-8 font-sans">
                Premium Collection aroma oils are professional-grade, high-performance fragrances developed for use with advanced scent diffuser systems. These fragrances are carefully formulated to provide consistent diffusion, superior longevity, and a refined scent profile across large and premium spaces.
              </p>
