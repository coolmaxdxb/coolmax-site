...
const EmaarAromaOilDetail = () => {
  ...
  return (
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
      <Helmet>
  <link rel="canonical" href="https://www.coolmaxscent.com/oriental-aroma-oil/emaar/" />
</Helmet>
      {/* ================= HERO SECTION ================= */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1 text-left">
            ...
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider text-left">
              Refined Oriental Fragrance for Calm & Premium Environments
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400 text-left">
                <span>Item Code: <span className="text-slate-900">CM-0104-OR</span></span>
                <span>Strength: <span className="text-blue-500 font-black">Medium</span></span>
            </div>
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 text-left">
              Emaar Aroma Oil is a smooth and elegant oriental fragrance crafted to create a calm, refined, and premium atmosphere. With soft floral notes balanced by woody and musky accords, this fragrance delivers a comfortable and sophisticated scent experience.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic text-left">
              It is ideal for environments that require a subtle yet luxurious fragrance presence.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
             {[
               { label: "Top Notes", notes: "Rose, Floral", color: "bg-blue-400" },
               { label: "Middle Notes", notes: "Cedarwood, Saffron", color: "bg-blue-600" },
               { label: "Base Notes", notes: "Musk, Patchouli", color: "bg-blue-800" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center">
            "This fragrance opens with gentle floral freshness, transitions into a warm woody-spice heart, and finishes with a soft musky base that remains pleasant and unobtrusive."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
           <div>
             ...
             <ul className="space-y-6">
                {[
                    "Soft floral and elegant opening",
                    "Warm, balanced oriental character",
                    "Smooth and comforting long-lasting finish"
                ].map((text, i) => (
                    <li key={i} className="flex items-center gap-4 text-lg text-slate-700 font-light font-sans text-left">
                        <div className="w-2.5 h-2.5 rounded-full bg-blue-400 shadow-[0_0_10px_rgba(96,165,250,0.5)]" /> {text}
                    </li>
                ))}
             </ul>
             <p className="mt-10 text-slate-500 leading-relaxed font-light text-left">
                Emaar Aroma Oil is designed for continuous use in professional and residential settings where comfort and elegance matter.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6">
              <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-600 transition-all duration-500 text-left">
              ...
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-600 transition-all duration-500 text-left">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Luxury Residences</span>
              </div>
      ...
      <section className="py-24 bg-slate-950 text-white px-6 text-left">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose Emaar Aroma?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    { title: "Controlled Diffusion", desc: "Medium strength intensity designed for perfectly balanced aromatic coverage." },
                    ...
                    <div key={i} className="p-10 rounded-[3rem] bg-white/5 border border-white/10 flex flex-col items-center gap-5 hover:bg-white/10 transition-colors text-left">
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed font-light text-left font-sans">{item.desc}</p>
                    </div>
                ))}
            </div>
        </div>
            ...
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left">
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed text-left">
                        Emaar Aroma Oil is a professional fragrance oil intended for use with automated scent diffuser machines. Diffusion intensity can be adjusted according to space size and airflow for optimal comfort.
                    </p>
                </div>
            </div>
        </div>
...
export default EmaarAromaOilDetail;