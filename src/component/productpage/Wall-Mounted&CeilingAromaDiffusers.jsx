      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-16">
        ...
        <section className="min-h-[75vh] flex flex-col lg:flex-row items-center pt-24 lg:pt-12 pb-12 gap-12 text-left">
          ...
          <div className="lg:w-1/2 relative flex items-center justify-center w-full">
            ...
            >
              ...
              <img 
                src={HeroImg} 
                alt="Fixed Installation Diffuser" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {[
              ...
              <motion.div 
                key={idx}
                {...smoothFadeUp}
                className="group p-8 rounded-[3rem] bg-slate-50 border border-slate-200 transition-all hover:bg-white hover:shadow-2xl text-left flex flex-col"
              >
        ...
        <section className="py-16">
          <div className="bg-slate-900 rounded-[3rem] p-10 md:p-20 text-left text-white relative overflow-hidden">
            <h2 className="text-3xl md:text-5xl font-serif mb-8 tracking-tighter leading-none">Why Choose Wall-Mounted & Ceiling Aroma Diffusers?</h2>
        ...
        <section className="py-16 bg-slate-50 rounded-[4rem] border border-slate-100">
          <div className="grid lg:grid-cols-2 gap-16 items-center px-8 md:px-16 text-left">
            ...
            <div className="rounded-[3rem] overflow-hidden shadow-2xl relative">
              <img src={FeatureImg} alt="Micro-atomization technology" className="w-full h-auto object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="bg-slate-50 rounded-[3rem] p-10 md:p-16 border border-slate-100 text-left">
            <h2 className="text-3xl md:text-5xl font-serif text-slate-900 mb-10 tracking-tighter">Why Choose Cool Max Wall-Mounted & Ceiling Diffusers?</h2>
        ...
        <section className="py-16 text-center">
           ...
           <p className="mt-8 text-slate-400 text-sm">These solutions work together to maintain consistent fragrance across different environments.</p>
        </section>
        ...
        <section className="py-24 text-center relative px-4">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="max-w-5xl mx-auto relative z-10">
            ...
            <p className="text-xl text-slate-500 mb-10 max-w-3xl mx-auto font-light leading-relaxed">
              Whether you are planning a new office setup or upgrading an existing commercial space, Cool Max offers reliable wall-mounted and ceiling aroma diffusers tailored to your needs. Our team will help you choose the right solution and provide ongoing support.
            </p>
