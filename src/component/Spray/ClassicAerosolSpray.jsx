    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
            <Helmet>
                ...
                <link rel="canonical" href="https://coolmaxscent.com/classic-aerosol-spray" />
            </Helmet>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8 font-sans">
                            <SparklesIcon className="w-4 h-4" /> Category: Citrus Floral Aerosol Air Freshener
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Classic <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider font-sans">
                            Timeless Freshness with Citrus, Florals & Soft Woods
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
                            Classic Aerosol Spray by Cool Max Scent is designed for spaces that require a clean, well-balanced fragrance with a timeless character. Combining fresh citrus, gentle florals, and warm woody notes, this spray creates a refined atmosphere that feels professional, calming, and welcoming.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans">
                            Ideal for continuous and automated use, Classic delivers consistent freshness without overwhelming the environment, making it suitable for both commercial and everyday applications.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto font-sans">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans">
                        {[
                            { label: "Top Notes", notes: "Lemon Zest", color: "bg-blue-400" },
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
                        "The fragrance opens with bright citrus freshness, transitions into soft floral tones, and settles into smooth woody notes that add depth and warmth."
                    </p>
                </div>
            </section>
                    ...
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Provides instant freshness and effective odor control",
                                "Wide dispersion for even fragrance coverage",
                                "Long-lasting, balanced scent performance",
                                "Leaves no residue",
...
export default ClassicAerosolSprayDetail;