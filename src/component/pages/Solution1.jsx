...
// --- Data Structure (Content Unchanged, Paths Updated for SEO) ---
const solutions = [
  {
    title: "Scent Marketing Solutions",
    path: "/scent-marketing-solutions/",
  ...
  },
  {
    ...
    path: "/commercial-aroma-diffusion-solutions/",
  ...
  },
  {
    ...
    path: "/washroom-hygiene-solutions/",
  ...
  },
  {
    ...
    path: "/car-and-personal-space-scenting-solutions/",
  ...
  },
  {
    ...
    path: "/maintenance-and-refill-support-services/",
    description: "With Cool Max Scent, fragrance management becomes simple, controlled, and reliable. We offer full support to ensure your systems perform perfectly year-round.",
    icon: (
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-20 max-w-4xl mx-auto text-center md:text-left">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm border-l-4 border-l-blue-600">
            <p className="text-lg text-slate-500 leading-relaxed font-medium text-left">
              At Cool Max Scent, we offer end-to-end home scent systems and commercial scenting solutions that are practical, effective, and easy to maintain. Our focus is not just on selling machines, but on helping our clients achieve a consistently fresh and pleasant indoor environment.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {solutions.map((item, index) => (
            ...
            >
              ...
              <p className="text-slate-500 leading-relaxed mb-10 text-base font-normal text-left">
                {item.description}
              </p>
