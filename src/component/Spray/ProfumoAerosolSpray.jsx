...
const ProfumoAerosolSprayDetail = () => {
    ...
    useEffect(() => {
        ...
        if (metaDescription) {
            metaDescription.setAttribute("content", "Profumo Aerosol Spray by Cool Max Scent blends lavender, lemon, geranium, cedarwood, and sandalwood for clean, balanced, long-lasting freshness.");
        }
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8 font-sans">
                            <SparklesIcon className="w-4 h-4" /> Category: Herbal Citrus Aerosol
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Profumo <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto font-sans">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans">
                        {[
                            { label: "Top Notes", notes: "Lavender, Lemon", color: "bg-blue-400" },
                            { label: "Middle Notes", notes: "Geranium", color: "bg-blue-600" },
                            { label: "Base Notes", notes: "Cedarwood, Sandalwood", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
                        "The fragrance opens with bright lemon and soft lavender, transitions into fresh geranium tones, and settles into a warm woody base of cedarwood and sandalwood."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left text-justify">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Instant freshness with balanced odor control",
                                "Crisp herbal–citrus fragrance profile",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 font-sans">
                            ...
                            <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100">Clinics & Healthcare</span>
                        </div>
                    ...
                    <div className="bg-slate-50 rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-center md:text-left text-left">
                        ...
                        <div className="text-left text-justify">
                            ...
                            <p className="text-slate-500 font-light leading-relaxed font-sans text-left">
                                Cool Max Scent aerosol sprays are developed to perform reliably in professional dispenser systems. They help maintain consistent fragrance quality, reduce odor concerns, and create welcoming indoor environments with minimal maintenance.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-6 text-center text-left">
                <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans text-left">
                    ...
                    <p className="text-slate-400 text-lg md:text-2xl mb-12 relative z-10 max-w-3xl mx-auto leading-relaxed font-light text-center text-left">
                        For automated fragrance control and consistent results, pair Profumo Aerosol Spray with Cool Max Scent LED or LCD Aerosol Dispensers.
                    </p>
...
export default ProfumoAerosolSprayDetail;