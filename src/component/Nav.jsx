...
const navigation = [
  { name: "Home", href: "/", type: "link" },
  {
    ...
    cols: 2,
    items: [
       { label: "Commercial Diffusers", href: "/commercial-aroma-diffusers/" },
        { label: "Large Area & HVAC", href: "/large-area-and-hvac-aroma-diffusers/ " },
      { label: "Car Aroma Diffusers", href: "/car-aroma-diffusers/" },
      { label: "Desktop & Small Space", href: "/desktop-and-small-space-aroma-diffusers/" },
      { label: "Wall-Mounted & Ceiling", href: "/wall-mounted-and-ceiling-aroma-diffusers/" },
      { label: "Floor-Standing Diffusers", href: "/floor-standing-aroma-diffusers/" },
      { label: "Passive/No-Power", href: "/no-power-diffusers/" },
      { label: "AerosolDispensers", href: "/aerosol-dispensers/" },
    ],
  },
  {
    name: "Aroma Oils",
    ...
    cols: 2,
    items: [
      { label: "Oriental Fragrances", href: "/oriental-aroma-oil/" },
      { label: "Fresh Fragrances", href: "/fresh-aroma-oil/" },
      { label: "Perfumers Choice", href: "/perfumers-choice-aroma-oil/" },
      { label: "Fruity Fragrances", href: "/fruity-aroma-oil/" },
      { label: "Food & Beverage Fragrances", href: "/food-and-beverage-aroma-oil/" },
      { label: "Premium Collection", href: "/premium-aroma-oil/" },
  ...
  { name: "Spray", href: "/spray/", type: "link" }, // Added Spray here
  {
    ...
    cols: 1,
    items: [
      { label: "Scent Marketing Strategy", href: "/scent-marketing-solutions/" },
      { label: "Commercial Aroma Diffusion", href: "/commercial-aroma-diffusion-solutions/" },
      { label: "HVAC Scenting Solutions", href: "/hvac-scenting-solutions/" },
      { label: "Washroom Hygiene Solutions", href: "/washroom-hygiene-solutions/" },
      { label: "Car & Personal Space Scenting", href: "/car-and-personal-space-scenting-solutions/" },
