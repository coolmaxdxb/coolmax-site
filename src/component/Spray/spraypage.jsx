...
const sprayProducts = [
  { id: 1, name: "Flora", cat: "Floral", code: "AS-01", img: floraImg, path: "/aroma-oil-spray/flora/" },
  { id: 2, name: "For You", cat: "Perfume", code: "AS-02", img: forYouImg, path: "/aroma-oil-spray/for-you/" },
  { id: 3, name: "Sense", cat: "Fresh", code: "AS-03", img: senseImg, path: "/aroma-oil-spray/sense/" },
  { id: 4, name: "Event", cat: "Premium", code: "AS-04", img: eventImg, path: "/aroma-oil-spray/event/" },
  { id: 5, name: "Vanilla Ice-Cream", cat: "Sweet", code: "AS-05", img: vanillaImg, path: "/aroma-oil-spray/vanilla-ice-cream/" },
  { id: 6, name: "Passion", cat: "Perfume", code: "AS-06", img: passionImg, path: "/aroma-oil-spray/passion/" },
  { id: 7, name: "Paris", cat: "Perfume", code: "AS-07", img: parisImg, path: "/aroma-oil-spray/paris/" },
  { id: 8, name: "Fresh Bakhoor", cat: "Oriental", code: "AS-08", img: freshBakhoorImg, path: "/aroma-oil-spray/fresh-bakhoor/" },
  { id: 9, name: "Fresh Jasmine", cat: "Floral", code: "AS-09", img: freshJasImg, path: "/aroma-oil-spray/fresh-jasmine/" },
  { id: 10, name: "Classic", cat: "Premium", code: "AS-10", img: classicImg, path: "/aroma-oil-spray/classic/" },
  { id: 11, name: "Strawberry", cat: "Fruity", code: "AS-11", img: strawberryImg, path: "/aroma-oil-spray/strawberry/" },
  { id: 12, name: "Rose", cat: "Floral", code: "AS-12", img: roseImg, path: "/aroma-oil-spray/rose/" },
  { id: 13, name: "Tradition", cat: "Oriental", code: "AS-13", img: traditionImg, path: "/aroma-oil-spray/tradition/" },
  { id: 14, name: "Fresh Lavender", cat: "Floral", code: "AS-14", img: freshLavenderImg, path: "/aroma-oil-spray/fresh-lavender/" },
  { id: 15, name: "Aura", cat: "Fresh", code: "AS-15", img: auraImg, path: "/aroma-oil-spray/aura/" },
  { id: 16, name: "Profumo", cat: "Perfume", code: "AS-16", img: profumoImg, path: "/aroma-oil-spray/profumo/" },
  { id: 17, name: "Fantastic", cat: "Premium", code: "AS-17", img: fantasticImg, path: "/aroma-oil-spray/fantastic/" },
  { id: 18, name: "Floral", cat: "Floral", code: "AS-18", img: floralImg, path: "/aroma-oil-spray/floral/" },
