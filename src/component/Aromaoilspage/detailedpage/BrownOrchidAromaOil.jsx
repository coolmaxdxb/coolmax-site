        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center text-left">
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-blue-900 mb-6 leading-[1.1] tracking-tighter uppercase">
              BROWN <span className="italic font-light text-slate-700">ORCHID</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
              Soft Floral Perfumers Choice Fragrance with Warm Elegance
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                <span>Item Code: <span className="text-slate-900">CM-0114-OR</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
              Brown Orchid Aroma Oil is a graceful and elegant fragrance designed to create a warm, inviting, and refined atmosphere. With bright citrus accents, soft florals, and a smooth woody base, this fragrance delivers a balanced and comforting scent experience suitable for everyday professional and residential use.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
              It is ideal for spaces that appreciate subtle luxury and floral sophistication.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
             {[
               { label: "Top Notes", notes: "Orange, Bergamot, Greedy, Jasmine", color: "bg-blue-400" },
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           ...
           <div className="grid grid-cols-2 gap-6 text-left">
              ...
              <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Boutiques & Retail</span>
              </div>
        ...
        <div className="max-w-[1200px] mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    ...
                    { title: "Elegant Profile", desc: "A sophisticated floral and woody character that defines subtle luxury." },
                    { title: "Elite Formulation", desc: "Professional-grade fragrance oil ensuring long-lasting and clean diffusion." },
                    { title: "Consistent Presence", desc: "High-performance formula that maintains its character steadily all day." },
...
export default BrownOrchidAromaOilDetail;