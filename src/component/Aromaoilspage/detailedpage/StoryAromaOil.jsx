...
const StoryAromaOilDetail = () => {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20Story%20Aroma%20Oil%20(CM-0113-OR).`;
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/perfumers-choice-aroma-oil/story/');
  }, []);
  ...
  return (
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center text-left">
          <motion.div {...fadeUp} className="order-2 lg:order-1 text-left">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase text-left">
              STORY <span className="italic font-light text-slate-700">AROMA OIL</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider font-sans text-left">
              Refined Perfumers Choice Fragrance with Warm & Elegant Character
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400 font-sans text-left">
                <span>Item Code: <span className="text-slate-900">CM-0113-OR</span></span>
                <span>Strength: <span className="text-blue-500 font-black">Medium</span></span>
            </div>
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans text-left">
              Story Aroma Oil is a refined and expressive fragrance crafted to create a balanced and elegant atmosphere. With a fresh citrus-spice opening, a warm floral heart, and a smooth woody-musky base, this fragrance delivers a comfortable and sophisticated scent experience.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto font-sans text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans text-center">
             {[
               ...
               { label: "Base Notes", notes: "Sandalwood, Vanilla Bean, Musk", color: "bg-blue-800" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center text-center">
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div className="text-left">
             ...
             <ul className="space-y-6 text-left">
                {[
                    "Fresh citrus-spice opening",
                    "Warm floral and woody character",
                    "Smooth, elegant, long-lasting finish"
                ].map((text, i) => (
           ...
           <div className="grid grid-cols-2 gap-6 text-left">
              <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 font-sans text-left text-left">
              ...
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 font-sans text-left text-left">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100 font-sans">Residences</span>
              </div>
              <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 font-sans text-left text-left">
                <ShoppingBagIcon className="w-12 h-12 text-blue-600 group-hover:text-white" />
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50 font-sans text-left">Retail Environments</span>
              </div>
              <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500 font-sans text-left text-left">
                <UserGroupIcon className="w-12 h-12 text-white text-left" />
                <span className="text-[11px] font-bold uppercase text-blue-50 font-sans">Reception Areas</span>
              </div>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-950 text-white px-6 font-sans text-left">
        <div className="max-w-[1200px] mx-auto text-center font-sans text-left">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center text-center text-center">Why Choose Story Aroma?</h2>
        ...
        <div className="max-w-[1000px] mx-auto text-left text-left">
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left text-left">
                ...
                <div className="text-left text-left">
                    <h2 className="text-2xl font-serif font-bold mb-4 uppercase text-slate-900 tracking-tight text-left text-left">Professional Usage & <span className="italic font-light text-left">Safety</span></h2>
                    <p className="text-slate-500 font-light leading-relaxed font-sans text-left text-left">
      ...
      <section className="py-24 px-6 text-center text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans text-center text-center">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-slate-100 text-center text-center text-center text-center text-center">Interested in <br/><span className="italic font-light text-slate-300 text-center text-center text-center text-center">this fragrance?</span></h2>
          ...
          <div className="flex flex-wrap justify-center gap-6 relative z-10 font-sans text-center text-center">
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="px-12 py-5 bg-white text-slate-900 rounded-full font-bold uppercase tracking-widest text-[11px] hover:bg-blue-600 hover:text-white transition-all shadow-xl flex items-center gap-3 text-center text-center">
               <ChatBubbleLeftRightIcon className="w-5 h-5 text-center text-center" /> WhatsApp Scent Expert
            </a>
...
export default StoryAromaOilDetail;