    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
            <Helmet>
                ...
                <link rel="canonical" href="https://coolmaxscent.com/event-aerosol-spray" />
            </Helmet>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Event <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
                            Woody Amber Air Freshener – Bold, Sophisticated Fragrance for Premium Environments
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
                            Event Aerosol Spray by Cool Max Scent is crafted to create a confident, refined, and premium atmosphere through a balanced blend of fresh citrus, woody notes, and deep amber tones. Designed for professional environments, this aerosol spray delivers instant freshness while maintaining a strong yet elegant scent profile.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
                            Its distinctive character makes it ideal for spaces that require a noticeable, long-lasting fragrance without feeling heavy or overpowering. Event works seamlessly in both manual application and automated aerosol dispenser systems.
                        </p>
                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        {[
                            ...
                            { label: "Heart Notes", notes: "Birch", color: "bg-blue-600" },
                            { label: "Base Notes", notes: "Ambergris", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic">
                        "The fragrance opens with fresh citrus brightness, followed by woody depth and a warm amber finish that creates a luxurious and confident atmosphere."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Delivers instant freshness and odor control",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-slate-200">Corporate Spaces</span>
                        </div>
            ...
            <section className="py-24 bg-slate-950 text-white px-6 text-left">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto">Event Aerosol Spray is developed for consistent performance in professional scenting systems, making it ideal for spaces that aim to create a strong, premium impression.</p>
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {["Washrooms & Restrooms", "Offices & Corporate", "Hotels & Hospitality", "Retail Stores", "Corridors & Common Areas"].map((item, i) => (
...
export default EventAerosolSprayDetail;