...
const VoyageAerosolSprayDetail = () => {
    ...
    useEffect(() => {
        ...
        if (metaDescription) {
            metaDescription.setAttribute("content", "Voyage Aerosol Spray by Cool Max Scent delivers a crisp fresh apple fragrance for clean, uplifting, long-lasting freshness in professional spaces.");
        }
        ...
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
                            Voyage Aerosol Spray by Cool Max Scent is designed to refresh indoor environments with a bright, clean apple fragrance that feels light and energizing. Simple, modern, and easy on the senses, this scent creates an instant feeling of freshness without overpowering the space.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans">
                            Ideal for continuous use, Voyage is well-suited for professional environments that require consistent odor control and a universally pleasant fragrance profile.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto font-sans">
                    ...
                    <div className="grid md:grid-cols-1 gap-8 mb-16 font-sans flex justify-center">
                        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-100 hover:border-blue-300 transition-all group text-center max-w-md mx-auto">
                            <div className="w-12 h-12 rounded-full bg-blue-500 mx-auto mb-6 flex items-center justify-center text-white">
                                <BeakerIcon className="w-6 h-6" />
                            </div>
                            <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 mb-4 text-center">Primary Note</h3>
                            <p className="text-xl font-serif text-slate-900 leading-snug text-center">Fresh Apple</p>
                        </div>
                    </div>
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
                        "A crisp green apple note delivers an immediate burst of freshness, creating a clean and airy atmosphere that feels natural and welcoming."
                    </p>
                </div>
            </section>
                    ...
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Instant freshness with effective odor neutralization",
                                "Wide fragrance dispersion for even coverage",
                                "Clean, crisp apple scent profile",
                                "Leaves no residue",
                    ...
                    <div className="bg-slate-50 rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-center md:text-left text-left">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-slate-500 font-light leading-relaxed font-sans text-left">
                                Cool Max Scent aerosol sprays are designed for reliable performance in professional dispenser systems. They help maintain clean, pleasant environments with controlled fragrance delivery and minimal maintenance effort.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-6 text-center text-left">
                <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans text-left">
                    ...
                    <p className="text-slate-400 text-lg md:text-2xl mb-12 relative z-10 max-w-3xl mx-auto leading-relaxed font-light font-sans text-center text-left">
                        For automated fragrance control and consistent freshness, pair Voyage Aerosol Spray with Cool Max Scent LED or LCD Aerosol Dispensers.
                    </p>
...
export default VoyageAerosolSprayDetail;