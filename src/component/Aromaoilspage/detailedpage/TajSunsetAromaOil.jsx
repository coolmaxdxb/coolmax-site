...
import P20 from "../../../asset/Aroma oils img/TAJ SUNSET.webp"; 

const TajSunsetAromaOilDetail = () => {
  // Redirection Links
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center font-sans">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
            "This fragrance opens with a bright citrus-spice burst, transitions into a luxurious floral heart, and finishes with a warm, creamy, and woody base that leaves a memorable impression."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div>
             ...
             <ul className="space-y-6">
                {[
                    "Vibrant and luxurious opening",
                    "Rich floral elegance at the core",
                    "Deep, warm, long-lasting finish"
                ].map((text, i) => (
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-sans font-light text-left">
                Taj Sunset Aroma Oil creates an atmosphere of grandeur, warmth, and premium comfort.
             </p>
           </div>
...
export default TajSunsetAromaOilDetail;