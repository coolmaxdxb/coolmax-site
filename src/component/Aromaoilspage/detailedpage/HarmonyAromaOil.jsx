...
import P10 from "../../../asset/Aroma oils img/HARMONY.webp"; 

const HarmonyAromaOilDetail = () => {
  // Redirection Links
  const whatsappNumber = "+971509282702";
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20Harmony%20Aroma%20Oil%20(CM-0107-OR).`;
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/perfumers-choice-aroma-oil/harmony/');
  }, []);
    ...
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-50 overflow-hidden tracking-tight text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1 text-left">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase ">
              HARMONY <span className="italic font-light text-slate-600">AROMA OIL</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
              Balanced Perfumers Choice Fragrance for Everyday Elegance
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                <span>Item Code: <span className="text-slate-900 font-sans">CM-0107-OR</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
              Harmony Aroma Oil is a well-balanced and elegant fragrance inspired by fine perfumery. With a smooth blend of citrus freshness, soft florals, and warm woody notes, this fragrance creates a pleasant, refined, and comfortable atmosphere suitable for everyday use.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
              It is ideal for spaces that require subtle sophistication without overpowering intensity.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 text-center">
             {[
               { label: "Top Notes", notes: "Bergamot, Pink Pepper, Pear", color: "bg-blue-400" },
               { label: "Middle Notes", notes: "Rose, Jasmine, Orris", color: "bg-blue-600" },
               { label: "Base Notes", notes: "Sandalwood, Cedarwood, Musk, Amber", color: "bg-blue-800" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center text-center">
            "This fragrance opens with a fresh citrus-spice note, develops into a soft floral heart, and finishes with a warm woody-musky base that feels smooth and inviting."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div>
             ...
             <ul className="space-y-6 text-left">
                {[
                    "Fresh and refined opening",
                    "Soft floral elegance at the core",
                    "Warm, balanced, long-lasting finish"
                ].map((text, i) => (
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-sans font-light text-left">
                Harmony Aroma Oil delivers a consistent and comfortable scent experience that feels professional and welcoming.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6 text-left text-left">
              <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 text-left">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-200">Offices</span>
              </div>
      ...
      <section className="py-24 bg-slate-950 text-white px-6 text-left">
        <div className="max-w-[1200px] mx-auto text-center text-left">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center text-center">Why Choose Harmony?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-left text-left">
                {[
                    { title: "Balanced Diffusion", desc: "Medium strength for perfectly controlled and sophisticated area coverage." },
            ...
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left text-left">
                ...
                <div className="text-left text-left">
                    ...
                    <p className="text-slate-500 font-light leading-relaxed text-left text-left">
                        Harmony Aroma Oil is a professional fragrance oil intended for use with automated scent diffuser machines. Fragrance intensity can be adjusted based on space size and airflow to ensure optimal comfort.
                    </p>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 px-6 text-center text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans text-center text-center">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-center text-white text-center text-center text-center">Interested in <br/><span className="italic font-light text-slate-300 text-center">this fragrance?</span></h2>
          <p className="text-slate-400 text-lg md:text-2xl mb-12 relative z-10 max-w-3xl mx-auto leading-relaxed font-light text-center text-center">
...
export default HarmonyAromaOilDetail;