...
const AeroBlackMedPage = () => {
  ...
  // --- SEO Implementation ---
  useEffect(() => {
    document.title = "AeroBlack Med Diffuser | Commercial Aroma Diffuser UAE";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "AeroBlack Med Diffuser is a professional commercial aroma diffuser for medium to large spaces with HVAC support, quiet operation, and smart control.");
    }
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/commercial-aroma-diffusers/aeroblack-med-diffuser/');
  }, []);
  ...
  return (
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden">
      ...
      <section className="relative pt-24 pb-12 px-6 lg:px-12 max-w-[1400px] mx-auto text-left">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeIn}>
            ...
            <p className="text-sm text-slate-500 mb-4 leading-relaxed text-left">
            ...
            <p className="text-sm text-slate-500 mb-8 leading-relaxed border-l-4 border-blue-600 pl-6 italic text-left">
      ...
      <section className="py-16 bg-white px-6 text-left">
        <div className="max-w-[1000px] mx-auto text-center">
          <motion.div {...fadeIn}>
            <h2 className="text-2xl md:text-4xl font-serif mb-6 text-center">Product Overview</h2>
            <p className="text-base text-slate-600 leading-relaxed max-w-4xl mx-auto text-center">
        ...
        <div className="max-w-[1400px] mx-auto text-left">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col items-center gap-2 text-center">
        ...
        <div className="grid gap-10 text-left">
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            <div className="order-2 md:order-1 text-left">
              <h3 className="text-xl font-serif mb-4 text-left">Advanced Magnetic Lock Technology</h3>
              <p className="text-sm text-slate-500 leading-relaxed text-left text-justify">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            ...
            <div className="text-left">
              <h3 className="text-xl font-serif mb-4 text-left">Smart Touch & Bluetooth App Control</h3>
              <p className="text-sm text-slate-500 mb-4 text-left">This scent diffuser machine supports touch panel control and Bluetooth app connectivity, allowing users to:</p>
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm col-span-2 text-left">
              <h3 className="text-xl font-serif mb-4 text-left">HVAC & Flexible Installation Support</h3>
              <p className="text-sm text-slate-500 mb-6 text-left text-justify">The AeroBlack Med Diffuser can be used as a standalone unit, mounted on a wall, placed on the floor, or connected directly to an HVAC scent diffuser system.</p>
              <div className="grid grid-cols-2 gap-3 text-left">
                 {["Standalone unit", "Wall-Mounted", "Floor-Standing", "Connected to HVAC"].map((item, i) => (
                    <div key={i} className="p-3 bg-slate-50 rounded-lg text-[9px] font-black uppercase tracking-widest text-slate-500 border border-slate-100 text-center">{item}</div>
                 ))}
              </div>
            </div>
            <div className="bg-blue-600 p-8 rounded-[2rem] text-white flex flex-col justify-center text-left">
               <h3 className="text-lg font-serif mb-4 leading-tight text-left">Efficient & Even Diffusion</h3>
               <p className="text-blue-100 text-[11px] mb-4 font-light text-left">Built-in fan ensures even scent distribution and faster spread with no residue.</p>
               <div className="w-full h-px bg-blue-500 my-2" />
               <p className="text-[10px] font-black tracking-widest uppercase italic opacity-70 text-left">≤38 dB Quiet Operation</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-left">
        <div className="grid lg:grid-cols-2 gap-10 items-center text-left">
          <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm text-left">
            <h2 className="text-2xl font-serif mb-6 leading-tight text-left">Where AeroBlack Med Works Best</h2>
            <div className="grid gap-2 text-left">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl text-left">
          ...
          <div className="flex flex-col justify-center text-left">
            <h2 className="text-2xl font-serif mb-6 leading-tight text-left">How it Works</h2>
            <p className="text-sm text-slate-500 leading-relaxed mb-6 text-left">
            ...
            <div className="p-6 rounded-2xl bg-blue-600 text-white shadow-xl shadow-blue-100 text-left">
               <BeakerIcon className="w-10 h-10 mb-4 text-left" />
               <h4 className="text-lg font-bold mb-1 text-left">Cold-Air Atomization</h4>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-left">
                ...
                <p className="text-[11px] font-light leading-relaxed text-left">{text}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-left">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-left">
          <div className="p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm text-left">
            <h4 className="text-lg font-bold mb-4 flex items-center gap-3 text-left text-slate-900"><WrenchScrewdriverIcon className="w-5 h-5 text-blue-600" /> Low Maintenance</h4>
      ...
      <section className="py-20 px-6 text-left">
        <div className="max-w-[1200px] mx-auto bg-slate-900 rounded-[4rem] p-10 md:p-16 text-center text-white relative overflow-hidden text-left">
          ...
          <p className="text-slate-400 text-lg mb-10 relative z-10 max-w-2xl mx-auto leading-relaxed text-center">
