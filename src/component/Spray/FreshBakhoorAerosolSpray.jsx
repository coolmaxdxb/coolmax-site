...
// --- ASSET IMPORT ---
import P_Bakhoor from "../../asset/Aerosol Spray/fresh bakhoor.webp"; 

const FreshBakhoorAerosolSprayDetail = () => {
    // --- SEO FIX LOGIC START ---
    useEffect(() => {
        // Update the browser tab title
        document.title = "Fresh Bakhoor Aerosol Spray | Oriental Air Freshener";
        ...
        link.setAttribute("href", "https://www.coolmaxscent.com/spray/fresh-bakhoor-aerosol-spray");
    }, []);
    // --- SEO FIX LOGIC END ---

    // Redirection Links
    const whatsappNumber = "+971509282702";
    const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20Fresh%20Bakhoor%20Aerosol%20Spray.`;
        ...
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Fresh Bakhoor <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
                            Oriental Air Freshener – Rich Traditional Aroma with a Modern Fresh Touch
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
                            Fresh Bakhoor Aerosol Spray by Cool Max Scent is crafted to deliver a deep, luxurious oriental fragrance inspired by traditional bakhoor notes. Blending warm spices, soft florals, and subtle sweetness, this spray creates an atmosphere that feels refined, welcoming, and culturally rich.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
                            Designed for professional and everyday environments, Fresh Bakhoor offers immediate freshness while maintaining a balanced and smooth scent experience. It works effectively for manual use and in automated aerosol dispenser systems.
                        </p>
                    ...
                    <motion.div {...fadeUp} className="order-1 lg:order-2 flex justify-center">
                        <div className="relative group">
                            ...
                            <img 
                                src={P_Bakhoor} 
                                alt="Fresh Bakhoor Aerosol Spray" 
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                        {[
                            { label: "Heart", notes: "Jasmine", color: "bg-blue-300" },
                            { label: "Heart", notes: "Rose", color: "bg-blue-400" },
                            { label: "Spice", notes: "Saffron", color: "bg-blue-500" },
                            { label: "Spice", notes: "Clove", color: "bg-blue-600" },
                            { label: "Base", notes: "Vanilla", color: "bg-blue-700" },
                            { label: "Top", notes: "Pineapple", color: "bg-blue-800" }
                        ].map((note, i) => (
                            <div key={i} className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 hover:border-blue-300 transition-all group text-center">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center">
                        "The fragrance opens with subtle fruity brightness, transitions into floral warmth, and settles into a rich spicy-vanilla base that creates a lasting oriental impression."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Long-lasting oriental scent performance",
                                "Leaves no residue",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100">Majlis Areas</span>
                        </div>
                        ...
                        <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-blue-50">Reception Zones</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-950 text-white px-6 text-left">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto text-center">Fresh Bakhoor Aerosol Spray is ideal for environments that aim to create a warm, elegant, and culturally refined atmosphere while maintaining professional hygiene standards.</p>
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {["Washrooms & Restrooms", "Hotels & Hospitality", "Offices & Corporate", "Retail & Showrooms", "Majlis & Reception"].map((item, i) => (
...
export default FreshBakhoorAerosolSprayDetail;