    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
            <Helmet>
                ...
                <link rel="canonical" href="https://coolmaxscent.com/passion-aerosol-spray" />
            </Helmet>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8">
                            <SparklesIcon className="w-4 h-4" /> Category: Fresh Citrus Aerosol Air Freshener
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Passion <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
                            Citrus Floral Air Freshener – Energetic Freshness with a Soft Floral Touch
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
                            Passion Aerosol Spray by Cool Max Scent is crafted to create a vibrant yet elegant fragrance experience. Combining fresh citrus notes with delicate florals and smooth woody undertones, this spray delivers a refreshing atmosphere that feels clean, lively, and well-balanced.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
                            Designed for both professional and everyday environments, Passion provides instant freshness while maintaining a refined scent profile that never feels overpowering. It works efficiently with both manual use and automated aerosol dispenser systems.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        {[
                            { label: "Opening Note", notes: "Lime", color: "bg-blue-300" },
                            { label: "Opening Note", notes: "Mandarins", color: "bg-blue-400" },
                            { label: "Heart Note", notes: "Lily-of-the-Valley", color: "bg-blue-600" },
                            { label: "Base Note", notes: "Bois de Rose", color: "bg-blue-800" }
                        ].map((note, i) => (
...
export default PassionAerosolSprayDetail;