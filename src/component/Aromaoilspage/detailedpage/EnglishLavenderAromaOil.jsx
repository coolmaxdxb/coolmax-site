...
const EnglishLavenderAromaOilDetail = () => {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/fresh-aroma-oil/english-lavender/');
  }, []);
    ...
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-50 overflow-hidden tracking-tight text-left">
      ...
      <section className="py-24 bg-white px-6 text-left">
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div>
             <h2 className="text-3xl md:text-5xl font-serif text-slate-950 leading-tight uppercase text-left">
      ...
      <section className="py-24 bg-slate-950 text-white px-6 text-center">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif text-center tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose English Lavender?</h2>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-center text-white">Interested in <br/><span className="italic font-light text-slate-300 text-center">this fragrance?</span></h2>
          ...
          <div className="flex flex-wrap justify-center gap-6 relative z-10 font-sans text-center">
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="px-12 py-5 bg-white text-slate-900 rounded-full font-bold uppercase tracking-widest text-[11px] hover:bg-blue-600 hover:text-white transition-all shadow-xl flex items-center justify-center gap-3 font-sans">
