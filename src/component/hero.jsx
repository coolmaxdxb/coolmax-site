...
export default function EcommerceHero() {
  ...
  return (
    <section className="relative w-full min-h-[700px] lg:h-[800px] flex flex-col lg:flex-row lg:items-center overflow-hidden font-sans bg-white lg:bg-transparent">
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden lg:flex gap-3 z-30">
        {currentImages.map((_, i) => (
          <button
            key={i}
            onClick={() => setIndex(i)}
