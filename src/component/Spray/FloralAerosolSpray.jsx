    ...
    return (
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
            <Helmet>
                ...
                <link rel="canonical" href="https://coolmaxscent.com/floral-aerosol-spray" />
            </Helmet>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8 font-sans">
                            <SparklesIcon className="w-4 h-4" /> Category: Floral Citrus Aerosol Air Freshener
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Floral <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider font-sans">
                            Citrus Lily Air Freshener – Delicate Floral Freshness with a Bright Citrus Opening
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
                            Floral Aerosol Spray by Cool Max Scent is designed to bring a soft yet refreshing fragrance into professional and everyday spaces. The blend of citrus brightness and gentle floral tones creates a clean, uplifting atmosphere that feels light, elegant, and welcoming.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans">
                            Crafted for consistent performance, Floral Aerosol Spray provides instant freshness while maintaining a smooth, balanced scent suitable for automated dispenser systems and manual use.
                        </p>
                ...
                <div className="max-w-[1200px] mx-auto font-sans">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans">
                        {[
                            ...
                            { label: "Base Notes", notes: "Musk, Cedar", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center">
                        "The fragrance opens with sparkling citrus from Sicilian orange, transitions into fresh lily tones, and settles into a subtle musky-woody base for a refined finish."
                    </p>
                </div>
            </section>
                    ...
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Instant fragrance release with odor control",
                                "Wide dispersion for uniform coverage",
                                "Soft citrus-floral scent profile",
                                "Leaves no residue",
            ...
            <section className="py-24 bg-slate-950 text-white px-6 font-sans">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto text-center">Floral Aerosol Spray is suitable for environments that require a gentle, refreshing scent that enhances comfort and supports a professional atmosphere.</p>
...
export default FloralAerosolSprayDetail;