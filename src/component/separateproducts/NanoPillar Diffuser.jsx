...
const NanoPillarPage = () => {
  ...
  return (
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden text-left">
     <Helmet>
  <link rel="canonical" href="https://www.coolmaxscent.com/floor-standing-aroma-diffurers/nano-pillar-diffuser/" />
</Helmet> 
        ...
        <div className="grid gap-16">
            ...
            <div className="order-2 text-left">
              ...
              <div className="bg-slate-900 text-white p-6 rounded-2xl text-left">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-[10px] font-black uppercase text-blue-100 mb-1">Bluetooth App</p>
                    <p className="text-slate-400 text-[10px] font-light">Manage intensity and scheduling via app.</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase text-blue-100 mb-1">Manual Control</p>
                    <p className="text-slate-400 text-[10px] font-light">Quick on-device button adjustments.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="bg-white border border-slate-100 p-8 rounded-[2rem] shadow-sm text-left">
              ...
              <p className="text-slate-500 text-xs leading-relaxed">Optional 10,400mAh battery for up to one week of cordless operation.</p>
            </div>
            <div className="bg-blue-600 text-white p-8 rounded-[2rem] shadow-xl text-left">
              ...
              <h3 className="text-lg font-serif mb-2 text-white">Ultra-Silent Mode</h3>
              <p className="text-blue-100 text-xs leading-relaxed font-light italic">Noise level ≤38 dB. Ideal for homes and quiet wellness environments.</p>
            </div>
            <div className="bg-white border border-slate-100 p-8 rounded-[2rem] shadow-sm text-left">
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-left">
        ...
        <p className="text-center mt-10 text-slate-500 text-xs italic">NanoPillar is perfect for customers looking for a professional aroma diffuser that blends into refined interiors.</p>
      </section>
