...
const WhiteTeaAromaOilDetail = () => {
  ...
  <link rel="canonical" href="https://www.coolmaxscent.com/fresh-aroma-oil/white-tea/"/>
      ...
      <section className="py-24 bg-slate-950 text-white px-6">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 text-center tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose White Tea?</h2>
