...
// --- ASSET IMPORT ---
import P_Jasmine from "../../asset/Aerosol Spray/fresh jas.webp"; 

const FreshJasmineAerosolSprayDetail = () => {
    // --- SEO FIX LOGIC START ---
    useEffect(() => {
        // Sets the browser tab title
        document.title = "Fresh Jasmine Aerosol Spray | Floral Air Freshener";
        ...
        link.setAttribute("href", "https://www.coolmaxscent.com/spray/fresh-jasmine-aerosol-spray");
    }, []);
    // --- SEO FIX LOGIC END ---

    // Redirection Links
    const whatsappNumber = "+971509282702";
    const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20Fresh%20Jasmine%20Aerosol%20Spray.`;
        ...
        <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase text-left">
                            Fresh Jasmine <span className="italic font-light text-slate-700 text-left">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider text-left">
                            Floral Air Freshener – Soft White Floral Fragrance for Calm, Everyday Freshness
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans text-justify">
                            Fresh Jasmine Aerosol Spray by Cool Max Scent is created to bring a light, soothing floral atmosphere into everyday spaces. Inspired by pure jasmine and delicate white florals, this fragrance delivers a clean and comforting scent that feels fresh without being overpowering.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic text-left">
                            Designed for both professional and regular use, Fresh Jasmine offers instant odor control while maintaining a gentle, elegant fragrance profile. It performs reliably in both manual application and automated aerosol dispenser systems.
                        </p>
                    ...
                    <motion.div {...fadeUp} className="order-1 lg:order-2 flex justify-center text-left">
                        <div className="relative group text-left">
                            ...
                            <img 
                                src={P_Jasmine} 
                                alt="Fresh Jasmine Aerosol Spray" 
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center text-left">
                <div className="max-w-[1200px] mx-auto text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 text-left">
                        {[
                            { label: "Star Note", notes: "Jasmine", color: "bg-blue-400" },
                            { label: "Heart Note", notes: "Gardenia", color: "bg-blue-600" },
                            { label: "Base Notes", notes: "White Floral Notes", color: "bg-blue-800" }
                        ].map((note, i) => (
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center text-left">
                        "The fragrance opens with fresh jasmine, followed by smooth gardenia tones and a soft white floral finish that creates a calm and pleasant environment."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6 text-left">
                            {[
                                ...
                                "Wide fragrance dispersion for balanced coverage",
                                "Long-lasting floral scent performance",
                                "Leaves no residue",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        <div className="aspect-square bg-slate-950 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500 text-left">
                            ...
                            <span className="text-[11px] font-bold uppercase text-slate-200 text-left">Offices & Clinics</span>
                        </div>
            ...
            <section className="py-24 bg-slate-950 text-white px-6 text-left text-left">
                <div className="max-w-[1200px] mx-auto text-center text-left">
                    ...
                    <p className="text-slate-400 mb-16 text-lg max-w-2xl mx-auto text-center text-left">Fresh Jasmine Aerosol Spray is ideal for spaces that require a clean, calming fragrance that supports comfort and hygiene perception throughout the day.</p>
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 text-left">
                        {["Washrooms & Restrooms", "Offices & Corporate", "Clinics & Healthcare", "Hotels & Hospitality", "Corridors & Elevators"].map((item, i) => (
...
export default FreshJasmineAerosolSprayDetail;