...
import PassionImg from "../../asset/Aroma oils img/LAVENDER.webp"; 
...
const PerfumersChoiceOilsPage = () => {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/perfumers-choice-aroma-oil/');
  }, []);
  ...
  const oils = [
    {
      ...
      strength: "Medium",
      path: "/perfumers-choice-aroma-oil/harmony/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Strong",
      path: "/perfumers-choice-aroma-oil/event/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Medium",
      path: "/perfumers-choice-aroma-oil/for-you/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Strong",
      path: "/perfumers-choice-aroma-oil/passion/",
      top: "Exquisite Aroma",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Strong",
      path: "/perfumers-choice-aroma-oil/gold/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Strong",
      path: "/perfumers-choice-aroma-oil/tuscan-leather/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Medium",
      path: "/perfumers-choice-aroma-oil/story/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Medium",
      path: "/perfumers-choice-aroma-oil/brown-orchid/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Medium",
      path: "/perfumers-choice-aroma-oil/scents-natural/",
    ...
    },
    {
      ...
      category: "Perfumers Choice",
      strength: "Strong",
      path: "/perfumers-choice-aroma-oil/splendor/",
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-24 pb-12 px-6 lg:px-12 max-w-[1600px] mx-auto text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-base text-slate-400 max-w-3xl mx-auto mb-10 text-center">
        ...
        <section className="py-24 px-6 text-center">
          <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-none uppercase italic text-slate-200 text-center">Refine Your Environment</h2>
