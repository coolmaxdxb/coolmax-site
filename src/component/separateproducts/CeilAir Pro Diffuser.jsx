...
const CeilAirProPage = () => {
  ...
  // --- SEO Implementation ---
  useEffect(() => {
    document.title = "CeilAir Pro Diffuser in Dubai | Commercial Scenting";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Smart CeilAir Pro Diffuser in Dubai for commercial spaces. Wall-mounted design, Bluetooth control, low noise, and easy maintenance across UAE.");
    }
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/wall-mounted-and-ceiling-aroma-diffusers/ceil-air-pro-diffuser/');
  }, []);
  ...
  return (
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden text-left">
      ...
      <section className="relative pt-24 pb-12 px-6 lg:px-12 max-w-[1600px] mx-auto text-left">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeIn}>
            ...
            <div className="flex flex-wrap gap-4 mt-6 font-sans text-left">
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-left">
        <h2 className="text-2xl md:text-4xl font-serif mb-12 text-center tracking-tight text-left">Premium Design & Build Quality</h2>
        
        <div className="grid gap-16 text-left">
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            <div className="order-2 md:order-1 text-left">
              <h3 className="text-xl font-serif mb-4 text-slate-900 text-left">No-Climbing Oil Replacement System</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            ...
            <div className="order-2 text-left">
              <h3 className="text-xl font-serif mb-4 text-slate-900 text-left">Smart Bluetooth Control</h3>
              <p className="text-sm text-slate-500 mb-4 font-light text-left">The built-in Bluetooth App control allows managers to maintain consistent scent levels effortlessly:</p>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            <div className="bg-slate-900 text-white p-8 rounded-[2rem] shadow-xl text-left">
               ...
               <h3 className="text-xl font-serif mb-2 text-left text-white">High-Pressure Atomization Technology</h3>
               <p className="text-slate-400 text-xs leading-relaxed mb-4 font-light text-left">Using a high-pressure spray nozzle, CeilAir Pro quickly atomizes essential oils into micron-size aromatic particles.</p>
            ...
            <div className="bg-blue-600 text-white p-8 rounded-[2rem] shadow-xl shadow-blue-100 text-left">
               ...
               <p className="text-blue-50 text-xs leading-relaxed mb-4 font-light italic text-left">With a noise level of ≤35 dB, CeilAir Pro operates quietly in the background, making it suitable for noise-sensitive environments.</p>
          ...
          <div className="p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center text-left">
             ...
             <h3 className="text-xl md:text-3xl font-serif mb-4 text-slate-900 text-center">Installation Flexibility</h3>
             <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed font-light mb-6 text-center">CeilAir Pro Diffuser is designed to be ceiling-mounted or wall-mounted, allowing installation without occupying floor or desk space.</p>
             <div className="flex gap-8 text-center text-left">
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-center text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center text-left text-left">
          <div className="relative h-80 text-left">
             <img src={CeilAirPro4} alt="CeilAir Maintenance" className="w-full h-full object-contain rounded-[2rem] shadow-xl text-left" />
             <div className="absolute -bottom-4 -right-4 p-6 bg-blue-600 text-white rounded-2xl shadow-xl text-left">
                <span className="text-xl font-black italic uppercase text-left">No Ladders</span>
                <p className="text-[8px] font-bold uppercase tracking-widest text-left">Safety-First Design</p>
             </div>
          </div>
          <div className="text-left">
            <h2 className="text-2xl md:text-4xl font-serif mb-6 tracking-tight leading-tight text-slate-900 text-left">Why Choose CeilAir Pro Diffuser</h2>
            ...
            <p className="mt-6 text-slate-400 font-medium text-[11px] italic text-left text-justify">CeilAir Pro is a reliable solution for businesses seeking a low-maintenance ceiling aroma diffuser.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 text-center text-left">
        <div className="max-w-[1200px] mx-auto bg-[#0c101b] rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl text-left text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mb-6 relative z-10 tracking-tight leading-tight uppercase text-white text-center">Upgrade Your Commercial Space</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 relative z-10 font-sans text-center text-left">
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="px-10 py-4 bg-white text-slate-900 rounded-xl font-black uppercase tracking-widest text-[10px] hover:bg-blue-600 hover:text-white transition-all shadow-xl flex items-center gap-2 text-center">
