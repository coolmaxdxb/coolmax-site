...
import P11 from "../../../asset/Aroma oils img/EVENT.webp"; 

const EventAromaOilDetail = () => {
  // Redirection Links
  const whatsappNumber = "+971509282702";
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hello%20Cool%20Max%20Scent,%20I%20am%20interested%20in%20the%20Event%20Aroma%20Oil%20(CM-0108-OR).`;
  ...
  <link rel="canonical" href="https://www.coolmaxscent.com/perfumers-choice-aroma-oil/event/"/>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1 text-left">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-blue-900 mb-6 leading-[1.1] tracking-tighter uppercase">
              EVENT <span className="italic font-light text-slate-700">AROMA OIL</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider text-left">
              Bold Perfumers Choice Fragrance for Dynamic & Professional Spaces
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400 text-left">
                <span>Item Code: <span className="text-slate-900">CM-0108-OR</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 text-left">
              Event Aroma Oil is a powerful and energetic fragrance designed to create a confident and impactful atmosphere. With aromatic herbal notes blended with woody and spicy accords, this fragrance delivers a bold and professional scent experience.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic text-left">
              It is ideal for spaces that require a strong, noticeable fragrance presence without compromising elegance.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
             {[
               { label: "Top Notes", notes: "Lavender, Rosemary", color: "bg-blue-500" },
               { label: "Middle Notes", notes: "Cedar, Woody Notes", color: "bg-blue-700" },
               { label: "Base Notes", notes: "Pepper", color: "bg-blue-900" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center">
            "This fragrance opens with fresh aromatic herbs, transitions into a dry woody heart, and finishes with a spicy base that adds depth and character."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
           <div>
             ...
             <ul className="space-y-6 mt-10">
                {[
                    ...
                    "Strong woody character at the core",
                    "Spicy, confident, long-lasting finish"
                ].map((text, i) => (
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-light font-sans text-left">
                Event Aroma Oil creates an energetic environment that feels modern, sharp, and professional.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6 text-left">
              ...
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                <CalendarDaysIcon className="w-12 h-12 text-blue-600 group-hover:text-white" />
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Event Venues</span>
              </div>
              <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                <PresentationChartBarIcon className="w-12 h-12 text-blue-600 group-hover:text-white" />
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Showrooms</span>
              </div>
      ...
      <section className="py-24 bg-slate-950 text-white px-6 text-left">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase text-center">Why Choose Event Aroma?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                {[
                    { title: "Impactful Diffusion", desc: "Strong intensity for spaces that require a powerful aromatic statement." },
                    ...
                    <div key={i} className="p-10 rounded-[3rem] bg-white/5 border border-white/10 flex flex-col items-center gap-5 hover:bg-white/10 transition-colors">
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed font-light font-sans text-center">{item.desc}</p>
                    </div>
                ))}
            </div>
        </div>
            ...
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left">
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed text-left">
                        Event Aroma Oil is a professional fragrance oil intended for use with automated scent diffuser machines. Fragrance intensity can be adjusted based on space size and airflow to ensure a controlled scent experience.
                    </p>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-slate-100 text-center text-center">Interested in <br/><span className="italic font-light text-slate-300 text-center">this fragrance?</span></h2>
...
export default EventAromaOilDetail;