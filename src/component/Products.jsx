...
const productList = [
  ...
  { id: 5, name: "AeroBlack Med diffuser",  cat: "Commercial Aroma Diffusers", images: [AeroBlackMed1, AeroBlackMed2], path: "/commercial-aroma-diffusers/aeroblack-med-diffuser/" },
  { id: 6, name: "MistBox X Diffuser",cat: "Commercial Aroma Diffusers", images: [MistBoxX1, MistBoxX2], path: "/commercial-aroma-diffusers/mistbox-x-diffuser/" },

  // --- 2. LARGE AREA & HVAC AROMA DIFFUSERS ---
  { id: 16, name: "AeroBlack Pro Diffuser",  cat: "Large Area & HVAC", images: [AeroBlackPro1, AeroBlackPro2], path: "/large-area-and-hvac-aroma-diffusers/aeroblack-pro-diffuser/" },
  { id: 17, name: "AirPulse 150",  cat: "Large Area & HVAC", images: [AirPulse1501, AirPulse1502], path: "/large-area-and-hvac-aroma-diffusers/air-pulse-150-diffuser/" },

  // --- 3. FLOOR-STANDING AROMA DIFFUSERS ---
  { id: 12, name: "NanoPillar Diffuser", cat: "Floor-Standing Aroma Diffusers", images: [NanoPillar1, NanoPillar2], path: "/floor-standing-aroma-diffusers/nano-pillar-diffuser/" },
  { id: 13, name: "Titan Diffuser",  cat: "Floor-Standing Aroma Diffusers", images: [Titan1, Titan2], path: "/floor-standing-aroma-diffusers/titan-diffuser/" },
  { id: 14, name: "AeroPillar Diffuser",  cat: "Floor-Standing Aroma Diffusers", images: [AeroPillar1, AeroPillar2], path: "/floor-standing-aroma-diffusers/aeropillar-diffuser/" },
  { id: 15, name: "AirPole Pro Diffuser",  cat: "Floor-Standing Aroma Diffusers", images: [AirPolePro1, AirPolePro2], path: "/floor-standing-aroma-diffusers/airpole-pro-diffuser/" },

  // --- 4. CAR AROMA DIFFUSERS ---
  { id: 1, name: "Vento Car", cat: "Car Aroma Diffusers", images: [VentoCar1, VentoCar2], path: "/car-aroma-diffusers/vento-car-diffuser/" },
  { id: 2, name: "DriveScent",  cat: "Car Aroma Diffusers", images: [DriveScent1, DriveScent2], path: "/car-aroma-diffusers/drive-scent-diffuser/" },
  { id: 3, name: "DeskScent", cat: "Car Aroma Diffusers", images: [DeskScent1, DeskScent2], path: "/car-aroma-diffusers/desk-scent-diffuser/" },
  { id: 4, name: "NovaCarDiffuser",  cat: "Car Aroma Diffusers", images: [NovaCar1, NovaCar2], path: "/car-aroma-diffusers/nova-car-diffuser/" },

  // --- 5. WALL-MOUNTED & CEILING AROMA DIFFUSERS ---
  { id: 7, name: "AeroCube Diffuser",  cat: "Wall-Mounted & Ceiling", images: [AeroCube1, AeroCube2], path: "/wall-mounted-and-ceiling-aroma-diffusers/aerocube-diffuser/" },
  { id: 8, name: "ZenBox Mini Diffuser",  cat: "Wall-Mounted & Ceiling", images: [ZenBoxMini1, ZenBoxMini2], path: "/wall-mounted-and-ceiling-aroma-diffusers/zenbox-mini-diffuser/" },
  { id: 10, name: "LuxePanel Diffuser", cat: "Wall-Mounted & Ceiling", images: [LuxePanel1, LuxePanel2], path: "/wall-mounted-and-ceiling-aroma-diffusers/luxepanel-diffuser/" },
  { id: 19, name: "CeilAir Pro Diffuser",  cat: "Wall-Mounted & Ceiling", images: [CeilAirPro1, CeilAirPro2], path: "/wall-mounted-and-ceiling-aroma-diffusers/ceil-air-pro-diffuser/" },
  { id: 20, name: "AeroMax Pro",  cat: "Wall-Mounted & Ceiling", images: [Aeromax1, Aeromax2 ], path: "/wall-mounted-and-ceiling-aroma-diffusers/aeromax-pro-diffuser/" },

  // --- 6. DESKTOP & SMALL SPACE AROMA DIFFUSERS ---
  { id: 9, name: "AromaDesk", cat: "Desktop & Small Space", images: [AromaDesk1, AromaDesk2], path: "/desktop-and-small-space-aroma-diffusers/aroma-desk-diffuser/" },
  { id: 11, name: "OpalMist Clock Diffuser", cat: "Desktop & Small Space", images: [OpalMist1, OpalMist2], path: "/desktop-and-small-space-aroma-diffusers/opalmist-clock-diffuser/" },

  // --- 7. PASSIVE / NO-POWER DIFFUSERS ---
  { id: 18, name: "Natural Fragrance Diffusion",  cat: "Passive / No-Power Diffusers", images: [NaturalFragrance1, NaturalFragrance2], path: "/no-power-diffusers/natural-fragrance-diffuser/" },
