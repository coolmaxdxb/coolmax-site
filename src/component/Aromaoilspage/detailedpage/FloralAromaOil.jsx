...
import P8 from "../../../asset/Aroma oils img/FLORAL.webp"; 
...
const FloralAromaOilDetail = () => {
  ...
  return (
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
      <Helmet>
  <link rel="canonical" href="https://www.coolmaxscent.com/fresh-aroma-oil/floral/" />
</Helmet>
      {/* ================= HERO SECTION ================= */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-blue-900 mb-6 leading-[1.1] tracking-tighter uppercase">
              FLORAL <span className="italic font-light text-slate-600">AROMA OIL</span>
            </h1>
            <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
              Soft Floral Fragrance for Fresh & Comfortable Environments
            </p>
            <div className="flex gap-6 mb-8 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                <span>Item Code: <span className="text-slate-900">CM-0120-FH</span></span>
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans">
              Floral Aroma Oil is a gentle and elegant fresh fragrance designed to create a pleasant, uplifting, and comfortable atmosphere. With refined floral notes balanced by soft musky and woody tones, this fragrance delivers a clean and soothing scent experience.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
              It is ideal for spaces that require freshness combined with subtle floral elegance.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
             {[
               { label: "Top Notes", notes: "Orange Blossom, Bergamot", color: "bg-blue-400" },
               { label: "Middle Notes", notes: "Tuberose, Indian Jasmine", color: "bg-blue-600" },
               { label: "Base Notes", notes: "Madagascar Vanilla, White Musk, Virginia Cedar", color: "bg-blue-800" }
             ].map((note, i) => (
               <div key={i} className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-100 hover:border-blue-300 transition-all group text-center">
                 ...
                 <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 mb-4 font-sans text-center">
                    {note.label}
                 </h3>
                 <p className="text-xl font-serif text-slate-900 leading-snug text-center">
                    {note.notes}
                 </p>
               </div>
             ))}
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic text-center">
            "This fragrance opens with bright citrus-floral freshness, develops into a rich floral heart, and finishes with a soft, creamy, and woody base that feels calm and comforting."
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center text-left">
           <div>
             ...
             <ul className="space-y-6">
                {[
                    "Bright and fresh floral opening",
                    "Smooth and elegant floral character",
                    "Soft, warm, long-lasting finish"
                ].map((text, i) => (
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-light text-left font-sans text-justify md:text-left">
                Floral Aroma Oil enhances spaces with a clean and welcoming scent without overwhelming the environment.
             </p>
           </div>
           <div className="grid grid-cols-2 gap-6 text-left">
              <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-600 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100">Residential</span>
              </div>
              ...
              <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-600 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-100">Wellness Spas</span>
              </div>
              <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500">
                ...
                <span className="text-[11px] font-bold uppercase text-blue-50">Waiting Areas</span>
              </div>
           </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                {[
                    ...
                    <div key={i} className="p-10 rounded-[3rem] bg-white/5 border border-white/10 flex flex-col items-center gap-5 hover:bg-white/10 transition-colors">
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed font-light text-center font-sans">{item.desc}</p>
                    </div>
                ))}
            </div>
        </div>
      ...
      <section className="py-28 bg-slate-50 px-6 text-left font-sans">
        <div className="max-w-[1000px] mx-auto text-left">
            <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center text-left">
                ...
                <div>
                    <h2 className="text-2xl font-serif font-bold mb-4 uppercase text-slate-900 tracking-tight text-left">
                        Professional Usage & <span className="italic font-light">Safety</span>
                    </h2>
                    <p className="text-slate-500 font-light leading-relaxed text-left text-justify md:text-left">
                        Floral Aroma Oil is a professional fragrance oil designed for use with automated scent diffuser machines. Diffusion intensity can be adjusted based on space size and airflow to ensure optimal comfort.
                    </p>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase text-slate-100 text-center">
            Interested in <br/><span className="italic font-light text-slate-300">this fragrance?</span>
          </h2>
...
export default FloralAromaOilDetail;