...
import P18 from "../../../asset/Aroma oils img/SCENTS NATURAL.webp"; 
    ...
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight text-left">
      ...
      <section className="relative pt-24 pb-16 px-6 lg:px-12 max-w-[1400px] mx-auto font-sans">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="order-2 lg:order-1 font-sans">
            ...
            <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8 font-sans text-left">
              Scents Natural Aroma Oil is a fresh and nature-inspired fragrance designed to create a clean, pleasant, and uplifting atmosphere. With vibrant fruity notes, soft florals, and a warm woody base, this fragrance delivers a balanced and refreshing scent experience suitable for daily use.
            </p>
            <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic font-sans text-left">
              It is ideal for spaces that prefer a natural, light, and welcoming fragrance presence.
            </p>
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 font-sans text-center">
        <div className="max-w-[1200px] mx-auto text-center font-sans">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 font-sans">
             {[
               { label: "Top Notes", notes: "Bergamot, Tangerine, Black Currant, Nectarine, Apple", color: "bg-blue-400" },
               { label: "Middle Notes", notes: "Gardenia, Magnolia, Jasmine, Freesia, Lily-of-the-Valley", color: "bg-blue-600" },
               { label: "Base Notes", notes: "Patchouli, Musk, Sandalwood, Vanilla, Amber", color: "bg-blue-800" }
             ].map((note, i) => (
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic font-sans text-center text-justify md:text-center">
            "This fragrance opens with bright fruity freshness, develops into a smooth floral heart, and finishes with a warm, soft woody base that feels comforting and long-lasting."
          </p>
        </div>
      </section>
           ...
           <div className="text-left">
             ...
             <ul className="space-y-6 text-left">
                {[
                    ...
                    "Soft floral and natural character",
...
export default ScentsNaturalAromaOilDetail;