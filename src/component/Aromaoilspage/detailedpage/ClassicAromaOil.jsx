                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
                            Classic Aroma Oil is a timeless and sophisticated fragrance designed to deliver a refined and luxurious atmosphere. With a vibrant citrus-spice opening, a rich floral heart, and a warm woody base, this fragrance offers a balanced, elegant, and long-lasting scent experience.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
                            It is ideal for spaces that prefer subtle luxury with a premium character.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic">
                        "This fragrance opens with fresh citrus and spice, transitions into a smooth floral heart, and finishes with a warm, creamy, and woody base that feels rich and comforting."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Rich floral sophistication at the core",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-50 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-slate-400 group-hover:text-blue-50">Premium Retail</span>
                        </div>
                        <div className="aspect-square bg-slate-100 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-blue-700 transition-all duration-500">
                            <ClockIcon className="w-12 h-12 text-blue-600 group-hover:text-white" />
                ...
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            { title: "Timeless Profile", desc: "A sophisticated premium fragrance that defines elegance and luxury in any setting." },
                            { title: "Elite Formulation", desc: "Professional-grade fragrance oil ensuring long-lasting, consistent, and clean diffusion." },
                            { title: "Reliable Longevity", desc: "High-performance longevity that maintains its refined character steadily all day." },
                    ...
                    <div className="bg-white rounded-[3rem] p-12 md:p-16 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 font-light leading-relaxed">
                                Classic Aroma Oil is a professional fragrance oil intended for use with automated scent diffuser machines. Diffusion intensity can be adjusted according to space size and airflow to maintain optimal scent comfort.
                            </p>
                        </div>
                    </div>
                </div>
...
export default ClassicAromaOilDetail;