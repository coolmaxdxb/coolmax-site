...
//   { id: 5, name: "AeroBlack Med diffuser", model: "Q500", cat: "Commercial Aroma Diffusers", path: "/commercial-aroma-diffusers/aeroblack-med-diffuser/", images: [AeroBlackMed1, AeroBlackMed2] },
//   { id: 6, name: "MistBox X Diffuser", model: "OV-10", cat: "Commercial Aroma Diffusers", path: "/commercial-aroma-diffusers/mistbox-x-diffuser/", images: [MistBoxX1, MistBoxX2] },

//   // --- 2. LARGE AREA & HVAC AROMA DIFFUSERS ---
//   { id: 16, name: "AeroBlack Pro Diffuser", model: "Q3000Pro", cat: "Large Area & HVAC Aroma Diffusers", path: "/commercial-aroma-diffusers/aeroblack-pro/", images: [AeroBlackPro1, AeroBlackPro2] },
//   { id: 17, name: "AirPulse 150", model: "VS-160", cat: "Large Area & HVAC Aroma Diffusers", path: "/large-area-and-hvac-aroma-diffusers/air-pulse-150-diffuser/", images: [AirPulse1501, AirPulse1502] },

//   // --- 3. FLOOR-STANDING AROMA DIFFUSERS ---
//   { id: 12, name: "NanoPillar Diffuser", model: "A500", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/nano-pillar-diffuser/", images: [NanoPillar1, NanoPillar2] },
//   { id: 13, name: "Titan Diffuser", model: "A700", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/titan-diffuser/", images: [Titan1, Titan2] },
//   { id: 14, name: "AeroPillar Diffuser", model: "F-Air", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/aeropillar-diffuser/", images: [AeroPillar1, AeroPillar2] },
//   { id: 15, name: "AirPole Pro Diffuser", model: "G-Air", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/airpole-pro-diffuser/", images: [AirPolePro1, AirPolePro2] },

//   // --- 4. CAR AROMA DIFFUSERS ---
//   { id: 1, name: "Vento Car", model: "H11-B-2026", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/vento-car-diffuser/", images: [VentoCar1, VentoCar2] },
//   { id: 2, name: "DriveScent", model: "H11-A-2026", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/drive-scent-diffuser/", images: [DriveScent1, DriveScent2] },
//   { id: 3, name: "DeskScent", model: "H19", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/desk-scent-diffuser/", images: [DeskScent1, DeskScent2] },
//   { id: 4, name: "NovaCarDiffuser", model: "DA1004-2026", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/nova-car-diffuser/", images: [NovaCar1, NovaCar2] },

//   // --- 5. WALL-MOUNTED & CEILING AROMA DIFFUSERS ---
//   { id: 7, name: "AeroCube Diffuser", model: "M41-B", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/aerocube-diffuser/", images: [AeroCube1, AeroCube2] },
//   { id: 8, name: "ZenBox Mini Diffuser", model: "D50mini", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/zenbox-mini-diffuser/", images: [ZenBoxMini1, ZenBoxMini2] },
//   { id: 10, name: "LuxePanel Diffuser", model: "OV-5/5Pro", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/luxepanel-diffuser/", images: [LuxePanel1, LuxePanel2] },
//   { id: 19, name: "CeilAir Pro Diffuser", model: "M45", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/ceil-air-pro-diffuser/", images: [CeilAirPro1, CeilAirPro2] },
//   { id: 20, name: "AeroMax Pro", model: "A315L", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/aeromax-pro-diffuser/", images: [Aeromax1, Aeromax2] },

//   // --- 6. DESKTOP & SMALL SPACE AROMA DIFFUSERS ---
//   { id: 9, name: "AromaDesk", model: "H10-A-2026", cat: "Desktop & Small Space Aroma Diffusers", path: "/desktop-and-small-space-aroma-diffusers/aroma-desk-diffuser/", images: [AromaDesk1, AromaDesk2] },
//   { id: 11, name: "OpalMist Clock Diffuser", model: "U2", cat: "Desktop & Small Space Aroma Diffusers", path: "/desktop-and-small-space-aroma-diffusers/opalmist-clock-diffuser/", images: [OpalMist1, OpalMist2] },

//   // --- 7. PASSIVE / NO-POWER DIFFUSERS ---
//   { id: 18, name: "Natural Fragrance Diffusion", model: "M10", cat: "Passive / No-Power Diffusers", path: "/no-power-diffusers/natural-fragrance-diffuser/", images: [NaturalFragrance1, NaturalFragrance2] },

//   // --- 8. AEROSOL DISPENSERS ---
//   { id: 21, name: "Aerosol Dispenser LCD", model: "LCD-AD", cat: "Aerosol Dispensers", path: "/aerosol-dispensers/", images: [Aerosol1, Aerosol2] }
// ];


const productList = [
  // --- 1. COMMERCIAL AROMA DIFFUSERS ---
  { id: 5, name: "AeroBlack Med diffuser", cat: "Commercial Aroma Diffusers", path: "/commercial-aroma-diffusers/aeroblack-med-diffuser/", images: [AeroBlackMed1, AeroBlackMed2] },
  { id: 6, name: "MistBox X Diffuser", cat: "Commercial Aroma Diffusers", path: "/commercial-aroma-diffusers/mistbox-x-diffuser/", images: [MistBoxX1, MistBoxX2] },

  // --- 2. LARGE AREA & HVAC AROMA DIFFUSERS ---
  { id: 16, name: "AeroBlack Pro Diffuser", cat: "Large Area & HVAC Aroma Diffusers", path: "/commercial-aroma-diffusers/aeroblack-pro/", images: [AeroBlackPro1, AeroBlackPro2] },
  { id: 17, name: "AirPulse 150", cat: "Large Area & HVAC Aroma Diffusers", path: "/large-area-and-hvac-aroma-diffusers/air-pulse-150-diffuser/", images: [AirPulse1501, AirPulse1502] },

  // --- 3. FLOOR-STANDING AROMA DIFFUSERS ---
  { id: 12, name: "NanoPillar Diffuser", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/nano-pillar-diffuser/", images: [NanoPillar1, NanoPillar2] },
  { id: 13, name: "Titan Diffuser", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/titan-diffuser/", images: [Titan1, Titan2] },
  { id: 14, name: "AeroPillar Diffuser", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/aeropillar-diffuser/", images: [AeroPillar1, AeroPillar2] },
  { id: 15, name: "AirPole Pro Diffuser", cat: "Floor-Standing Aroma Diffusers", path: "/floor-standing-aroma-diffusers/airpole-pro-diffuser/", images: [AirPolePro1, AirPolePro2] },

  // --- 4. CAR AROMA DIFFUSERS ---
  { id: 1, name: "Vento Car", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/vento-car-diffuser/", images: [VentoCar1, VentoCar2] },
  { id: 2, name: "DriveScent", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/drive-scent-diffuser/", images: [DriveScent1, DriveScent2] },
  { id: 3, name: "DeskScent", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/desk-scent-diffuser/", images: [DeskScent1, DeskScent2] },
  { id: 4, name: "NovaCarDiffuser", cat: "Car Aroma Diffusers", path: "/car-aroma-diffusers/nova-car-diffuser/", images: [NovaCar1, NovaCar2] },

  // --- 5. WALL-MOUNTED & CEILING AROMA DIFFUSERS ---
  { id: 7, name: "AeroCube Diffuser", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/aerocube-diffuser/", images: [AeroCube1, AeroCube2] },
  { id: 8, name: "ZenBox Mini Diffuser", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/zenbox-mini-diffuser/", images: [ZenBoxMini1, ZenBoxMini2] },
  { id: 10, name: "LuxePanel Diffuser", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/luxepanel-diffuser/", images: [LuxePanel1, LuxePanel2] },
  { id: 19, name: "CeilAir Pro Diffuser", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/ceil-air-pro-diffuser/", images: [CeilAirPro1, CeilAirPro2] },
  { id: 20, name: "AeroMax Pro", cat: "Wall-Mounted & Ceiling Aroma Diffusers", path: "/wall-mounted-and-ceiling-aroma-diffusers/aeromax-pro-diffuser/", images: [Aeromax1, Aeromax2] },

  // --- 6. DESKTOP & SMALL SPACE AROMA DIFFUSERS ---
  { id: 9, name: "AromaDesk", cat: "Desktop & Small Space Aroma Diffusers", path: "/desktop-and-small-space-aroma-diffusers/aroma-desk-diffuser/", images: [AromaDesk1, AromaDesk2] },
  { id: 11, name: "OpalMist Clock Diffuser", cat: "Desktop & Small Space Aroma Diffusers", path: "/desktop-and-small-space-aroma-diffusers/opalmist-clock-diffuser/", images: [OpalMist1, OpalMist2] },

  // --- 7. PASSIVE / NO-POWER DIFFUSERS ---
  { id: 18, name: "Natural Fragrance Diffusion", cat: "Passive / No-Power Diffusers", path: "/no-power-diffusers/natural-fragrance-diffuser/", images: [NaturalFragrance1, NaturalFragrance2] },

  // --- 8. AEROSOL DISPENSERS ---
  { id: 21, name: "Aerosol Dispenser LCD", cat: "Aerosol Dispensers", path: "/aerosol-dispensers/", images: [Aerosol1, Aerosol2] }
];
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#FAF9F6] text-slate-900 font-sans pt-16">
      ...
      <aside className="hidden lg:flex w-72 flex-col border-r border-slate-200/50 sticky top-16 h-[calc(100vh-64px)] bg-white z-20">
        <div className="p-8 pb-4 text-left">
          <h1 className="text-xl font-black tracking-tighter uppercase italic text-left">COOLMAX<span className="text-blue-600">.</span></h1>
          <p className="text-[9px] font-bold text-slate-400 mt-1 uppercase tracking-[0.2em] text-left">Atmospheric Tech 2026</p>
        </div>
        ...
        <nav className="flex-1 px-4 py-2 space-y-0.5 overflow-y-auto no-scrollbar text-left">
          {categories.map(cat => (
            <button 
              key={cat} 
      ...
      {/* --- MAIN CONTENT --- */}
      <main className="flex-1 p-4 lg:p-10 text-left">
