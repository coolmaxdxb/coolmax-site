                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp} className="order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.3em] mb-8">
                            <SparklesIcon className="w-4 h-4" /> Category: Aerosol Air Freshener
                        </div>
                        <h1 className="text-5xl md:text-7xl font-serif text-slate-950 mb-6 leading-[1.1] tracking-tighter uppercase">
                            Flora <span className="italic font-light text-slate-700">Aerosol Spray</span>
                        </h1>
                        <p className="text-xl text-blue-600 font-medium mb-4 uppercase tracking-wider">
                            Gentle Floral Fragrance for Everyday Freshness
                        </p>
                        ...
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed font-light mb-8">
                            Flora Aerosol Spray by Cool Max Scent is designed to deliver a soft, refreshing floral fragrance that enhances indoor environments without overpowering the space. Crafted for regular use, this aerosol air freshener helps maintain a clean, pleasant atmosphere in homes, offices, washrooms, and commercial areas.
                        </p>
                        <p className="text-base text-slate-500 leading-relaxed font-light mb-10 italic">
                            Inspired by fresh fruits and delicate florals, Flora creates a balanced scent profile that feels natural, calming, and welcoming—ideal for daily freshness and odor control.
                        </p>
            ...
            <section className="py-24 bg-slate-50 px-6 lg:px-12 text-center">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-16">
                        {[
                            { label: "Top Notes", notes: "Apple", color: "bg-blue-300" },
                            { label: "Fruit Blend", notes: "Peach", color: "bg-blue-400" },
                            { label: "Fresh Accents", notes: "Green Notes", color: "bg-blue-500" },
                            { label: "Core Note", notes: "Rose", color: "bg-blue-600" },
                            { label: "Core Note", notes: "Jasmine", color: "bg-blue-700" }
                        ].map((note, i) => (
                            <div key={i} className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 hover:border-blue-300 transition-all group text-center">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light italic">
                        "This blend opens with light fruity notes and settles into smooth floral tones, making it suitable for both professional and shared environments."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <ul className="space-y-6">
                            {[
                                ...
                                "Helps neutralize unpleasant odors",
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        ...
                        <div className="aspect-square bg-blue-600 rounded-[2.5rem] p-8 flex flex-col justify-end gap-3 group hover:bg-slate-950 transition-all duration-500">
                            ...
                            <span className="text-[11px] font-bold uppercase text-blue-50">Elevators & Corridors</span>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            ...
                            { title: "Offices", desc: "Delivers a professional, fresh atmosphere." },
                            { title: "Hotels", desc: "Perfect for corridors and hospitality areas." },
                            { title: "Retail", desc: "Enhances the customer shopping experience." },
                            { title: "Lifts", desc: "Refreshing scent for small enclosed spaces." }
                        ].map((item, i) => (
                            <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 flex flex-col items-center gap-4 hover:bg-white/10 transition-colors">
                                ...
                                <p className="text-[10px] text-slate-400 font-light leading-relaxed">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
...
export default FloraAerosolSprayDetail;