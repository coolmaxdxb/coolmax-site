...
const AeroCubePage = () => {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/wall-mounted-and-ceiling-aroma-diffusers/aerocube-diffuser/');
  }, []);
    ...
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeIn}>
            ...
            <div className="flex flex-wrap gap-4 mt-6 text-left">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-slate-900 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-blue-600 transition-all flex items-center gap-2 shadow-lg">
        ...
        <div className="grid gap-16 text-left">
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            <div className="order-2 md:order-1 text-left">
              <h3 className="text-xl font-serif mb-4 text-left">Clean & Minimal Design</h3>
              ...
              <p className="text-slate-400 text-xs italic text-left">This flexibility allows it to blend effortlessly into both light and dark interiors.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center text-left">
            ...
            <div className="text-left">
              <h3 className="text-xl font-serif mb-4 text-left">Adjustable Diffusion Control</h3>
              <p className="text-sm text-slate-500 mb-4 font-light text-left">AeroCube Diffuser allows users total authority over their environment:</p>
              ...
              <p className="text-slate-400 text-xs italic border-l-2 border-slate-200 pl-4 text-left">This ensures fragrance output is consistent, effective, and never overpowering.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            <div className="bg-slate-900 text-white p-8 rounded-[2rem] shadow-xl text-left">
               ...
               <h3 className="text-xl font-serif mb-2 text-left">High-Performance Atomization</h3>
               <p className="text-slate-400 text-xs leading-relaxed mb-4 font-light text-left">Equipped with a new high-performance atomizer ensuring fine even fragrance, low noise, and stable volume. The built-in fan accelerates distribution to every corner.</p>
               <div className="flex gap-4 text-[9px] font-black uppercase text-blue-100 tracking-widest text-left">
            ...
            <div className="bg-blue-600 text-white p-8 rounded-[2rem] shadow-xl shadow-blue-100 text-left">
               <WrenchScrewdriverIcon className="w-10 h-10 text-white mb-4 text-left" />
               <h3 className="text-xl font-serif mb-2 text-left">Easy Maintenance</h3>
               <p className="text-blue-50 text-xs leading-relaxed mb-4 font-light italic text-left">The plug-in atomizer design allows for quick replacement and easy cleaning, reducing downtime for busy commercial facilities.</p>
               <div className="p-3 bg-white/10 rounded-xl border border-white/10 inline-block text-left">
          ...
          <div className="p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center">
             ...
             <h3 className="text-xl md:text-3xl font-serif mb-4 text-center">Quiet & Reliable Performance</h3>
             <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed font-light mb-6 text-center">With a noise level of ≤36 dB, AeroCube Diffuser operates quietly, ensuring comfort without disturbance in sensitive professional settings.</p>
      ...
      <section className="py-16 bg-slate-50 px-6 text-left">
        <div className="max-w-[800px] mx-auto text-left">
          <h2 className="text-2xl md:text-4xl font-serif mb-10 text-center tracking-tight text-center">Technical Specifications</h2>
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-center">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center text-left">
          <div className="relative h-80 text-left">
             <img src={AeroCube4} alt="Close-up Detail" className="w-full h-full object-contain rounded-[2rem] shadow-xl text-left" />
             <div className="absolute -bottom-4 -right-4 p-6 bg-blue-600 text-white rounded-2xl shadow-xl text-left">
                <span className="text-2xl font-black italic text-left">300m³</span>
                <p className="text-[8px] font-bold uppercase tracking-widest text-left">Strong Coverage</p>
             </div>
          </div>
          <div className="text-left">
            <h2 className="text-2xl md:text-4xl font-serif mb-6 tracking-tight leading-tight text-left">Why Choose AeroCube Diffuser</h2>
            ...
            <p className="mt-6 text-slate-400 font-medium text-[11px] italic text-left text-justify">AeroCube Diffuser is a dependable choice for businesses seeking consistent performance.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 text-left">
        <div className="max-w-[1200px] mx-auto bg-[#0c101b] rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mb-6 relative z-10 tracking-tight leading-tight text-center">Create a Fresh & Welcoming Environment</h2>
          <p className="text-slate-400 text-lg mb-10 relative z-10 max-w-2xl mx-auto leading-relaxed font-light font-sans text-center">
