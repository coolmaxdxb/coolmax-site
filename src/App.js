...
const HotelsHospitality = lazy(() => import("./component/HotelsHospitality"));
...
const Blog6 = lazy(() => import("../src/component/blogs/blog6"));
const Blog7 = lazy(() => import("../src/component/blogs/blog7"));
const Blog8 = lazy(() => import("../src/component/blogs/blog8"));
const Blog9 = lazy(() => import("../src/component/blogs/blog9"));
const Blog10 = lazy(() => import("../src/component/blogs/blog10"));
const Blog11 = lazy(() => import("../src/component/blogs/blog11"));
const Blog12 = lazy(() => import("../src/component/blogs/blog12"));
const Blog13 = lazy(() => import("../src/component/blogs/blog13"));
const Blog14 = lazy(() => import("../src/component/blogs/blog14"));
...
const Blog17 = lazy(() => import("../src/component/blogs/blog17"));
  ...
  const Blog28 = lazy(() => import("../src/component/blogs/blog28"));
    ...
    const Blog38 = lazy(() => import("../src/component/blogs/blog38"));
    const Blog39 = lazy(() => import("../src/component/blogs/blog39"));
    const Blog40 = lazy(() => import("../src/component/blogs/blog40"));
    ...
    const Blog45 = lazy(() => import("../src/component/blogs/blog45"));
    const Blog46 = lazy(() => import("../src/component/blogs/blog46"));
    const Blog47 = lazy(() => import("../src/component/blogs/blog47"));
    const Blog48 = lazy(() => import("../src/component/blogs/blog48"));
    const Blog49 = lazy(() => import("../src/component/blogs/blog49"));
    const Blog50 = lazy(() => import("../src/component/blogs/blog50"));
    const Blog51 = lazy(() => import("../src/component/blogs/blog51"));
    const Blog52 = lazy(() => import("../src/component/blogs/blog52"));
    const Blog53 = lazy(() => import("../src/component/blogs/blog53"));
    ...
    const Blog58 = lazy(() => import("../src/component/blogs/blog58"));
    ...
    <Router>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/industries/aroma-diffuser-for-hotels-dubai/" element={<HotelsHospitality />} />
          ...
          <Route path="/blog/scent-solutions-corporate-reception-areas/" element={<Blog5 />} />
           ...
           <Route path="/blog/why-modern-offices-use-scent-systems/" element={<Blog7 />} />
           <Route path="/blog/seasonal-scenting-with-aroma-diffusers/" element={<Blog8 />} />
           <Route path="/blog/commercial-scent-diffuser-vs-air-freshener" element={<Blog9 />} />
           <Route path="/blog/how-to-choose-best-scent-diffuser-machine/" element={<Blog10 />} />
           <Route path="/blog/clean-and-maintain-your-diffuser-for-long-lasting-performance/" element={<Blog11 />} />
            <Route path="/blog/aroma-diffuser-machine-uae-fragrance-solutions-in-uae/" element={<Blog12 />} />
            <Route path="/blog/hvac-scent-diffuser-system-uae/" element={<Blog13 />} />
            <Route path="/blog/best-essential-aroma-oil-diffuser-for-any-room/" element={<Blog14 />} />
            <Route path="/blog/summer-odor-control-homes-offices-malls-with-cool-max-scent/" element={<Blog15 />} />
                         ...
                         <Route path="/blog/uae-qatar-aerosol-spray-dispenser-vs-automatic-scent-diffuser/" element={<Blog24 />} />
                            <Route path="/blog/dubai-hotel-scent-marketing-home-fragrance-uae/" element={<Blog25 />} />
                               <Route path="/blog/supermarkets-dubai-scent-diffusers-shopping-experience/" element={<Blog26 />} />
                                  ...
                                  <Route path="/blog/aroma-diffuser-for-commercial-restrooms-in-dubai/" element={<Blog38 />} />
                                  ...
                                  <Route path="/blog/corporate-scenting-solutions-dubai/" element={<Blog44 />} />
                                   ...
                                   <Route path="/blog/aroma-diffuser-for-schools-in-dubai/" element={<Blog46 />} />
                                   <Route path="/blog/hvac-scenting-systems-dubai-commercial-spaces/" element={<Blog47 />} />
                                   <Route path="/blog/retail-store-aroma-diffuser-dubai/" element={<Blog48 />} />
                                   <Route path="/blog/commercial-aroma-diffuser-retail-stores/" element={<Blog49 />} />
                                   <Route path="/blog/commercial-fragrance-intensity-guide/" element={<Blog50 />} />
                                   <Route path="/blog/aroma-diffuser-for-hotel-in-uae/" element={<Blog51 />} />
                                   <Route path="/blog/commercial-aroma-diffuser-for-car-showroom/" element={<Blog52 />} />
                                   <Route path="/blog/gym-fragrance-solutions-dubai-fresh-fitness-centers/" element={<Blog53 />} />
                                   ...
                                   <Route path="/blog/how-to-choose-right-fragrance-for-your-business/" element={<Blog58 />} />
