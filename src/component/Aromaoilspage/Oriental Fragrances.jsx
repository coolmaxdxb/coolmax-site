...
const OrientalAromaOilsPage = () => {
  ...
  useEffect(() => {
    ...
    // Dynamic SEO update
    document.title = "Oriental Aroma Oils for Hotels & Luxury Spaces | Cool Max Scent";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Explore premium oriental aroma oils by Cool Max Scent. Discover rich, long-lasting fragrances designed for hotels, offices, and luxury commercial spaces.");
    }
    ...
    canonical.setAttribute('href', 'https://www.coolmaxscent.com/oriental-aroma-oil/');
  }, []);
        ...
        <section className="py-20 bg-slate-50 px-6 lg:px-12" id="collection">
          <div className="max-w-[1400px] mx-auto">
            <h2 className="text-3xl md:text-5xl font-serif mb-16 tracking-tight text-slate-950 uppercase text-center">
              Oriental <span className="italic font-light">Aroma Oil Collection</span>
            </h2>
